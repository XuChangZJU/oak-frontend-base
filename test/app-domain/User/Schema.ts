...
export type Schema = {
    ...
    house$owner?: Array<House.Schema>;
...
type CreateOperationData = FormCreateData<Omit<OpSchema, "refId" | "ref"> & ({
    ...
    house$owner?: House.CreateOperation | House.UpdateOperation;
...
type UpdateOperationData = FormUpdateData<Omit<OpSchema, "refId" | "ref">> & ({
    ...
    houses$owner?: House.CreateOperation | Omit<House.UpdateOperation, "id" | "ids" | "filter">;
...
type RemoveOperationData = {} & {
    ...
    houses$owner?: Omit<House.UpdateOperation | House.RemoveOperation, "id" | "ids" | "filter">;
...
export type FullAttr = NativeAttr | `mobiles$${number}.${Mobile.NativeAttr}` | `userSystems$${number}.${UserSystem.NativeAttr}` | `tokens$user$${number}.${Token.NativeAttr}` | `tokens$player$${number}.${Token.NativeAttr}` | `users$${number}.${NativeAttr}` | `wechatUsers$${number}.${WechatUser.NativeAttr}` | `houses$${number}.${House.NativeAttr}` | `extraFiles$${number}.${ExtraFile.NativeAttr}`;
