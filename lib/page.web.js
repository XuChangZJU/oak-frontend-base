    ...
    var OakComponentWrapper = /** @class */ (function (_super) {
        ...
        function OakComponentWrapper(props) {
            ...
            Object.assign(methodProps, {
                ...
                setId: function (id) {
                    return _this.setId(id);
                },
                unsetId: function () {
                    return _this.unsetId();
                }
            });
            Object.assign(methodProps, {
        ...
        OakComponentWrapper.prototype.render = function () {
            ...
            if (this.supportPullDownRefresh()) {
                return ((0, jsx_runtime_1.jsx)(web_1.PullToRefresh, { onRefresh: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
