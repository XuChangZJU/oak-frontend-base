...
function createPage(options, features, exceptionRouterDict, context) {
    ...
    var OakPageWrapper = /** @class */ (function (_super) {
        ...
        OakPageWrapper.prototype.render = function () {
            ...
            return react_1.default.cloneElement((0, jsx_runtime_1.jsx)(PullToRefresh_1.default, { onRefresh: function () {
...
function createComponent(options, features, exceptionRouterDict, context) {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    ...
                    if (oakParent || oakPath) {
                        oakFullpath = "".concat(oakParent || '').concat(oakParent && oakPath ? '.' : '').concat(oakPath || '');
                        this.setState({
        ...
        OakComponentWrapper.prototype.onPropsChanged = function (options) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    ...
                    oakFullpath2 = "".concat(parent2 || '').concat(parent2 && path2 ? '.' : '').concat(path2 || '');
                    if (oakFullpath2) {
    ...
    return (0, router_1.default)(OakComponentWrapper, true);
}
