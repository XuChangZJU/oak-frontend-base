...
function checkActionsAndCascadeEntities(rows, option) {
    ...
    if (actions) {
        ...
        try {
            ...
            for (var actions_2 = tslib_1.__values(actions), actions_2_1 = actions_2.next(); !actions_2_1.done; actions_2_1 = actions_2.next()) {
                    ...
                    if (rows instanceof Array) {
                        if (action === 'create' || typeof action === 'object' && action.action === 'create') {
                            ...
                            var intrinsticFilter = rel_1[1] ? (_e = {},
                                _e[rel_1[1].slice(0, rel_1[1].length - 2)] = this_2.features.runningTree.getIntrinsticFilters(this_2.state.oakFullpath),
                                _e) : (_f = {},
                                _f[this_2.state.oakEntity] = this_2.features.runningTree.getIntrinsticFilters(this_2.state.oakFullpath),
                                _f);
