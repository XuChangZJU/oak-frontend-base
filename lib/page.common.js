...
exports.makePageMethods = exports.makeListComponentMethods = exports.makeComponentOnlyMethods = exports.makeCommonComponentMethods = exports.makeHiddenComponentMethods = void 0;
...
function makeComponentOnlyMethods(formData, entity, actions) {
    return {
        onPropsChanged: function (params) {
            var path2 = params.hasOwnProperty('path')
                ? params.path
                : this.props.oakPath;
            var parent2 = params.hasOwnProperty('parent')
                ? params.parent
                : this.props.oakParent;
            var oakFullpath2 = "".concat(parent2 || '').concat(parent2 && path2 ? '.' : '').concat(path2 || '');
            if (oakFullpath2) {
        ...
        registerReRender: function () {
            var _this = this;
            var _a = this.props, oakPath = _a.oakPath, oakParent = _a.oakParent;
            if (oakParent || oakPath) {
                var oakFullpath = "".concat(oakParent || '').concat(oakParent && oakPath ? '.' : '').concat(oakPath || '');
                this.setState({
                    oakFullpath: oakFullpath,
                    oakEntity: entity,
                }, function () {
                    typeof formData === 'function' &&
                        _this.reRender.call(_this);
                });
            }
            else {
        ...
        setOakActions: function () {
            var oakActions = this.props.oakActions;
            this.setState({
...
exports.makeComponentOnlyMethods = makeComponentOnlyMethods;
...
function makePageMethods(features, options) {
    return {
        refresh: function (pullDownRefresh) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var err_3;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
        ...
        onPullDownRefresh: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.refresh(true)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        loadMore: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.state.oakEntity &&
                                this.state.oakFullpath &&
                                options.isList)) return [3 /*break*/, 4];
                            this.setState({
                                oakMoreLoading: true,
                            });
                            _a.label = 1;
