        ...
        for (const action of actions) {
            if (rows instanceof Array) {
                ...
                if (action === 'create' || typeof action === 'object' && action.action === 'create') {
                    ...
                    const data = typeof action === 'object' && Object.assign((0, lodash_1.cloneDeep)(action.data) || {}, { id: (0, uuid_1.generateNewId)() });
...
async function refresh(inMounting) {
    if (this.state.oakFullpath) {
...
async function execute(action, path, messageProps) {
