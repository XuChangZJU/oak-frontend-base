...
var withRouter = function (Component) {
    var ComponentWithRouterProp = function (props) {
        ...
        return ((0, jsx_runtime_1.jsx)(Component, tslib_1.__assign({ ref: forwardedRef }, rest, params, { navigate: navigate, location: location, t: t, i18n: i18n, width: width })));
    };
    return React.forwardRef(function (props, ref) {
        return (0, jsx_runtime_1.jsx)(ComponentWithRouterProp, tslib_1.__assign({}, props, { forwardedRef: ref }));
    });
};
