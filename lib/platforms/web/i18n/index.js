...
function translationService(keys, language, namespace) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var url, response, json, e_1, result;
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (process.env.NODE_ENV !== 'production') {
                        console.warn("[i18n]:\u8BF7\u6C42".concat(url, "\u5931\u8D25"));
                    }
                    return [3 /*break*/, 5];
                case 5:
...
function getI18nextInitOptions(options) {
    var _a = options || {}, _b = _a.version, version = _b === void 0 ? '1.0.0' : _b, _c = _a.debug, debug = _c === void 0 ? false : _c;
    return {
        debug: debug,
        fallbackLng: 'zh_CN',
        ns: ['common', 'error'],
