...
var withRouter = function (Component, isComponent, path) {
    var ComponentWithRouterProp = function (props) {
        ...
        return ((0, jsx_runtime_1.jsx)(Component, tslib_1.__assign({}, rest, params, { t: t, i18n: i18n, width: width, navigate: navigate, location: location, ref: forwardedRef, routeMatch: routeMatch })));
    };
