...
exports.analyzeAttrMobileForCard = exports.analyzeDataUpsertTransformer = exports.makeDataTransformer = exports.getType = exports.getAlign = exports.getValue = exports.getWidth = exports.getLabel = exports.getPath = exports.resolvePath = exports.getAttributes = void 0;
...
function getLabel(attribute, entity, attr, t) {
    ...
    if (attr === '$$createAt$$' ||
        attr === '$$updateAt$$' ||
        attr === '$$deleteAt$$') {
        label = t("oak-frontend-base-l-common.".concat(attr));
    }
...
function getValue(data, path, entity, attr, attrType, t) {
    ...
    if (attrType === 'boolean' && typeof value === 'boolean') {
        value = t("oak-frontend-base-l-common.".concat(String(value)));
    }
