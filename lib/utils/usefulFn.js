...
function analyzeDataUpsertTransformer(dataSchema, entity, attrUpsertDefs, t) {
    ...
    var makeNativeFixedPart = function (attr, def) {
        ...
        return {
            ...
            type: type,
            required: required,
            defaultValue: (def === null || def === void 0 ? void 0 : def.hasOwnProperty('defaultValue')) ? def.defaultValue : defaultValue,
            ...
            maxLength: typeof (def === null || def === void 0 ? void 0 : def.maxLength) === 'number' ? def.maxLength : params === null || params === void 0 ? void 0 : params.length,
    ...
    var transformerFixedPart = attrUpsertDefs.map(function (ele) {
        if (typeof ele === 'string') {
            ...
            var _a = ele, attr = _a.attr, label = _a.label, rest = tslib_1.__rest(_a, ["attr", "label"]);
            var rel = (0, relation_1.judgeRelation)(dataSchema, entity, attr);
            if (rel === 1) {
                var fixedPart = makeNativeFixedPart(attr, ele);
                return Object.assign(fixedPart, tslib_1.__assign({ label: label || t("".concat(entity, ":attr.").concat(attr)) }, rest));
            }
    ...
    return function (data) {
        ...
        var coverData = data.map(function (row) {
            ...
            if (mobileAttrDef.title) {
                title = typeof mobileAttrDef.title === 'string' ? (0, lodash_1.get)(row, mobileAttrDef.title) : mobileAttrDef.title;
            }
            // rows即卡片主体要渲染的数据
