...
var SubScriber = /** @class */ (function (_super) {
    ...
    function SubScriber(cache, getSubscribePointUrl) {
        ...
        _this.cache = cache;
        _this.getSubscribePointUrl = getSubscribePointUrl;
        return _this;
    }
    ...
    SubScriber.prototype.initSocketOption = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response, _a, url, path, port, socket;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, fetch(this.getSubscribePointUrl)];
                    case 1:
                        response = _b.sent();
