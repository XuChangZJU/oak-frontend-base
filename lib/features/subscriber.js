...
var SubScriber = /** @class */ (function (_super) {
    ...
    SubScriber.prototype.emit = function (event) {
        ...
        this.eventCallbackMap[event].forEach(function (ele) { return ele(data); });
    };
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                ...
                                socket.on('connect', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        ...
                                        socket.on('data', function (opRecords, ids) {
                                            _this.cache.sync(opRecords);
                                            _this.emit('data', {
                                                ids: ids,
                                                opRecords: opRecords,
                                            });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (this.socketState === 'unconnected') {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            _this.socket.emit('sub', data, function (result) {
                                if (result) {
                                    _this.message.setMessage({
                                        type: 'error',
                                        title: 'sub data error',
    ...
    SubScriber.prototype.unsub = function (ids) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                ids.forEach(function (id) { return (0, lodash_1.unset)(_this.subDataMap, id); });
