...
var RelationAuth = /** @class */ (function (_super) {
    ...
    RelationAuth.prototype.getCascadeActionEntities = function (entity) {
        var paths = this.actionCascadePathGraph.filter(function (ele) { return ele[0] === entity; });
        return paths;
    };
    RelationAuth.prototype.getCascadeRelationEntitiesByRoot = function (entity) {
        var relations = this.relationCascadePathGraph.filter(function (ele) { return ele[2] === entity; });
        return relations;
    };
