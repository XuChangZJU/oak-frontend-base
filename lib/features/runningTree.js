                ...
                case 'c': {
                    ...
                    if (e === this.entity) {
                        ...
                        if (d instanceof Array) {
                            d.forEach((dd) => {
                                if (!filter || (!this.sr.hasOwnProperty(dd.id) && (0, filter_1.checkFilterContains)(e, context, filter, {
                                    id: dd.id,
                                }))) {
                            ...
                            if (!filter || (!this.sr.hasOwnProperty(d.id) && (0, filter_1.checkFilterContains)(e, context, filter, {
                                id: d.id,
                            }))) {
                    ...
                    if (e === this.entity) {
                        if (!f) {
                            ...
                            for (const id in this.sr) {
                                if (!f || (0, filter_1.checkFilterContains)(e, context, f, { id })) {
        ...
        if (this.dirty) {
            ...
            for (const k in originUpdates) {
                if (originUpdates[k].action === 'create') {
                    (0, lodash_1.unset)(this.sr, originUpdates[k].data.id);
                }
            }
            this.dirty = undefined;
            this.publish();
...
class SingleNode extends Node {
    ...
    saveRefreshResult(data) {
        ...
        (0, assert_1.assert)(ids.length === 1);
        this.id = ids[0];
        this.sr = data[ids[0]];
        this.passRsToChild();
        this.publish();
...
class RunningTree extends Feature_1.Feature {
    ...
    getEntity(path) {
        const node = this.findNode(path);
        (0, assert_1.assert)(node instanceof Node);
