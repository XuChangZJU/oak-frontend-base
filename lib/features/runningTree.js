    ...
    ListNode.prototype.constructSelection = function (withParent, disableOperation) {
        ...
        if (withParent && this.parent) {
            if (this.parent instanceof SingleNode) {
                var filterOfParent = this.parent.getParentFilter(this, disableOperation);
                if (filterOfParent) {
        ...
        var filter = filters2.length > 0 ? (0, filter_1.combineFilters)(filters2) : undefined;
        return {
            data: data,
            filter: filter,
            sorter: sorterArr,
...
var SingleNode = /** @class */ (function (_super) {
    ...
    SingleNode.prototype.tryGetParentFilter = function (disableOperation) {
        ...
        if (parent instanceof SingleNode) {
            var filter = parent.getParentFilter(this, disableOperation);
            return filter;
        }
    ...
    SingleNode.prototype.refresh = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var id, parentFilter, id2, projection, filter, err_2;
            var _this = this;
                    ...
                    case 0:
                        ...
                        if (!id) {
                            if (this.parent instanceof ListNode) {
                                ...
                                parentFilter = this.parent.getParentFilter(this);
                                if (parentFilter) {
                                    id2 = parentFilter.id;
                                    id = id2;
                                }
    ...
    SingleNode.prototype.getParentFilter = function (childNode, disableOperation) {
        var _a;
        var value = this.getFreshValue(disableOperation);
        if (!value) {
            return;
        }
