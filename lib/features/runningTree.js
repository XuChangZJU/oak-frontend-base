...
var ListNode = /** @class */ (function (_super) {
    ...
    function ListNode(entity, schema, cache, relationAuth, projection, parent, path, filters, sorters, pagination, actions, cascadeActions) {
    ...
    ListNode.prototype.setFiltersAndSortedApplied = function () {
        this.filters.forEach(function (ele) { return ele.applied = true; });
        this.sorters.forEach(function (ele) { return ele.applied = true; });
        for (var k in this.children) {
    ...
    ListNode.prototype.setNamedFilters = function (filters, refresh) {
        this.filters = filters.map(function (ele) { return Object.assign({}, ele, { applied: false }); });
        if (refresh) {
            this.refresh(1, true);
        }
        else {
    ...
    ListNode.prototype.setNamedSorters = function (sorters, refresh) {
        this.sorters = sorters.map(function (ele) { return Object.assign({}, ele, { applied: false }); });
        if (refresh) {
            this.refresh(1, true);
        }
        else {
    ...
    ListNode.prototype.getFreshValue = function () {
        ...
        if (filter || this.ids) {
            ...
            var r2_1 = result.filter(function (ele) { var _a; return ele.$$createAt$$ === 1 || ((_a = _this.ids) === null || _a === void 0 ? void 0 : _a.includes(ele.id)); }).sort(function (ele1, ele2) {
                ...
                var idx1 = _this.ids.indexOf(ele1.id);
                var idx2 = _this.ids.indexOf(ele2.id);
                return idx1 - idx2;
            });
            if (this.aggr) {
                // 如果有聚合查询的结果，这里按理不应该有aggregate和create同时出现，但也以防万一
                this.aggr.forEach(function (ele, idx) {
                    var id = _this.ids[idx];
                    (0, assert_1.assert)(id);
                    var row = r2_1.find(function (ele) { return ele.id === id; });
                    (0, assert_1.assert)(id);
    ...
    ListNode.prototype.addItem = function (item, beforeExecute, afterExecute) {
        ...
        this.updates[id] = {
            ...
            operation: {
                ...
                action: 'create',
                data: item.id ? item : Object.assign(item, { id: id }),
            },
        };
        this.setDirty();
        return id;
    ...
    ListNode.prototype.removeItem = function (id, beforeExecute, afterExecute) {
        var _a;
        if (this.updates[id] &&
            ((_a = this.updates[id].operation) === null || _a === void 0 ? void 0 : _a.action) === 'create') {
            // 如果是新增项，在这里抵消
    ...
    ListNode.prototype.recoverItem = function (id) {
        ...
        (0, assert_1.assert)((operation === null || operation === void 0 ? void 0 : operation.action) === 'remove');
        (0, lodash_1.unset)(this.updates, id);
        this.setDirty();
    };
    ListNode.prototype.resetItem = function (id) {
        var operation = this.updates[id].operation;
        (0, assert_1.assert)((operation === null || operation === void 0 ? void 0 : operation.action) === 'update');
        (0, lodash_1.unset)(this.updates, id);
        this.setDirty();
    };
    /**
    ...
    ListNode.prototype.doBeforeTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _i, k, _d, _e, _f, _g, k, update;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 5:
                        ...
                        if (!update.beforeExecute) return [3 /*break*/, 7];
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 5:
                        ...
                        k = _f;
                        update = this.updates[k];
                        if (!update.afterExecute) return [3 /*break*/, 7];
    ...
    ListNode.prototype.composeOperations = function () {
        ...
        var _loop_1 = function (id) {
            ...
            if (childOperation) {
                ...
                (0, assert_1.assert)(!['create', 'remove'].includes(action), '在list结点上对子结点进行增删请使用父结点的addItem/removeItem，不要使用子结点的create/remove');
    ...
    ListNode.prototype.refresh = function (pageNumber, getCount, append) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, entity, pagination, currentPage, pageSize, randomRange, currentPage3, _b, projection, filter, sorter, err_1;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this, entity = _a.entity, pagination = _a.pagination;
                        currentPage = pagination.currentPage, pageSize = pagination.pageSize, randomRange = pagination.randomRange;
                        ...
                        _b = this.constructSelection(true, true), projection = _b.data, filter = _b.filter, sorter = _b.sorter;
                        if (!((!this.getParent() || filter) && projection)) return [3 /*break*/, 5];
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        ...
                        return [4 /*yield*/, this.cache.refresh(entity, {
                                ...
                                var ids = _a.ids, count = _a.count, aggr = _a.aggr;
    ...
    ListNode.prototype.getIntrinsticFilters = function () {
        var filters = this.constructFilters(undefined, true, true);
...
var SingleNode = /** @class */ (function (_super) {
    ...
    SingleNode.prototype.setFiltersAndSortedApplied = function () {
        for (var k in this.children) {
            this.children[k].setFiltersAndSortedApplied();
        }
    };
    ...
    SingleNode.prototype.setId = function (id) {
        ...
        if (id !== this.id) {
            ...
            if (((_b = (_a = this.operation) === null || _a === void 0 ? void 0 : _a.operation) === null || _b === void 0 ? void 0 : _b.action) === 'create') {
    ...
    SingleNode.prototype.getId = function () {
        ...
        if (this.operation && ((_a = this.operation.operation) === null || _a === void 0 ? void 0 : _a.action) === 'create') {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        if (!((_a = this.operation) === null || _a === void 0 ? void 0 : _a.beforeExecute)) return [3 /*break*/, 6];
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        if (!((_a = this.operation) === null || _a === void 0 ? void 0 : _a.afterExecute)) return [3 /*break*/, 6];
    ...
    SingleNode.prototype.getFilter = function () {
        ...
        if (this.filters) {
            filter = (0, filter_1.combineFilters)(this.entity, this.schema, this.filters.map(function (ele) { return typeof ele.filter === 'function' ? ele.filter() : ele.filter; }).concat(filter));
        }
        return filter;
    };
...
var VirtualNode = /** @class */ (function (_super) {
    ...
    VirtualNode.prototype.setFiltersAndSortedApplied = function () {
        for (var k in this.children) {
            this.children[k].setFiltersAndSortedApplied();
        }
    };
    ...
    VirtualNode.prototype.clean = function (preserveAfterExecute) {
        for (var ele in this.children) {
...
var RunningTree = /** @class */ (function (_super) {
    ...
    function RunningTree(cache, schema, relationAuth) {
        var _this = _super.call(this) || this;
    ...
    RunningTree.prototype.isCreation = function (path) {
        var node = this.findNode(path);
        (0, assert_1.assert)(node instanceof SingleNode);
        var oper = node.composeOperations();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(operations.length > 0)) return [3 /*break*/, 5];
                    ...
                    case 6:
                        _a.sent();
                        return [2 /*return*/, { message: 'No Operation' }];
                    case 7:
                        err_4 = _a.sent();
                        node.setExecuting(false);
                        throw err_4;
