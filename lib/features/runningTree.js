...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getFreshValue = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var createdIds, k, operation, data, modies, _a, operations, selection, filter, result;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        createdIds = [];
                        for (k in this.updates) {
                            operation = this.updates[k].operation;
    ...
    ListNode.prototype.addItem = function (item, beforeExecute, afterExecute) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, generateNewId()];
                    case 1:
                        id = _e.sent();
                    ...
                    case 2:
                        _a[_b] = (_c.operation = (_d.id = _e.sent(),
                            _d.action = 'create',
                            _d.data = Object.assign(item, { id: id }),
                            _d),
                            _c);
                        this.setDirty();
                        return [2 /*return*/];
    ...
    ListNode.prototype.removeItem = function (id, beforeExecute, afterExecute) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!(this.updates[id] && this.updates[id].operation.action === 'create')) return [3 /*break*/, 1];
                        // 如果是新增项，在这里抵消
    ...
    ListNode.prototype.updateItem = function (data, id, action, beforeExecute, afterExecute) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var operation, dataOrigin, _a, _b;
            var _c, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        (0, assert_1.assert)(Object.keys(this.children).length === 0, "\u66F4\u65B0\u5B50\u7ED3\u70B9\u5E94\u8BE5\u843D\u5728\u76F8\u5E94\u7684component\u4E0A");
                        if (!this.updates[id]) return [3 /*break*/, 1];
                        operation = this.updates[id].operation;
                        dataOrigin = operation.data;
    ...
    ListNode.prototype.composeOperations = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var childOperations, _a, _b, _i, id, childOperation, operations, id, operation, childOperation;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        id = _a[_i];
                        return [4 /*yield*/, this.children[id].composeOperations()];
                    case 2:
                        childOperation = _c.sent();
                        if (childOperation) {
                    ...
                    case 5:
                        _c.sent();
                        return [2 /*return*/, operations.map(function (ele) { return Object.assign({
                                operation: ele,
                                entity: _this.entity,
                            }); })];
                }
...
var SingleNode = /** @class */ (function (_super) {
    ...
    function SingleNode(entity, schema, cache, projection, parent, id) {
        ...
        if (id) {
            ...
            _this.tryGetParentFilter()
                .then(function () { return _this.create({}); });
        }
        return _this;
    }
    SingleNode.prototype.tryGetParentFilter = function (disableOperation) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var parent, filter;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(parent instanceof SingleNode)) return [3 /*break*/, 2];
                        return [4 /*yield*/, parent.getParentFilter(this, disableOperation)];
                    case 1:
                        filter = _a.sent();
                        return [2 /*return*/, filter];
                    case 2:
                        if (!(parent instanceof ListNode)) return [3 /*break*/, 4];
                        return [4 /*yield*/, parent.getParentFilter(this)];
    ...
    SingleNode.prototype.getFreshValue = function (disableOperation) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var projection, modies, _a, operations, filter, result;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.tryGetParentFilter(disableOperation)];
                    case 4:
                        // 还可能是来自父级的外键
                        filter = _b.sent();
                        _b.label = 5;
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, generateNewId()];
                    case 2:
                        _a.operation = (_b.operation = (_c.id = _d.sent(),
                            _c.action = 'create',
                            _c.data = Object.assign({}, data, { id: id }),
                            _c),
                            _b.beforeExecute = beforeExecute,
                            _b.afterExecute = afterExecute,
                            _b);
                        this.setDirty();
                        return [2 /*return*/];
                }
    ...
    SingleNode.prototype.update = function (data, action, beforeExecute, afterExecute) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.operation) return [3 /*break*/, 2];
                        _a = {};
                        return [4 /*yield*/, generateNewId()];
                    case 1:
                        operation = (_a.id = _b.sent(),
                            _a.action = action || 'update',
                            _a.data = data,
                            _a);
                        if (this.id) {
    ...
    SingleNode.prototype.composeOperations = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var operation, _a, _b, _c, _i, ele, child, childOperations, sliceIdx, ele2, childOpers;
            var _d, _e, _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        if (!this.operation) return [3 /*break*/, 1];
                        _a = (0, lodash_1.cloneDeep)(this.operation.operation);
                        return [3 /*break*/, 3];
                    case 1:
                        _d = {};
                        return [4 /*yield*/, generateNewId()];
                    ...
                    case 5:
                        ...
                        if (childOperations) {
                            if (child instanceof SingleNode) {
                                ...
                                Object.assign(operation.data, (_e = {},
                                    _e[ele2] = childOperations[0].operation,
                                    _e));
                            }
                            else {
                                (0, assert_1.assert)(child instanceof ListNode);
                                childOpers = childOperations.map(function (ele) { return ele.operation; });
                                if (operation.data[ele2]) {
                                    (_f = operation.data[ele2]).push.apply(_f, tslib_1.__spreadArray([], tslib_1.__read(childOpers), false));
                                }
                                else {
    ...
    SingleNode.prototype.refresh = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var id, parentFilter, id2, projection, filter, _a, value, modi$entity, err_2;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = this.id;
...
function repairOperations(entity, schema, operations) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        var operations_1, operations_1_1, operation, _a, data, data_1, data_1_1, d, e_10_1, e_11_1;
        var e_11, _b, e_10, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 4:
                    ...
                    data_1 = (e_10 = void 0, tslib_1.__values(data)), data_1_1 = data_1.next();
                    _d.label = 5;
                case 5:
...
var RunningTree = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, node.addItem(data, beforeExecute, afterExecute)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        node = this.findNode(path);
                        (0, assert_1.assert)(node instanceof ListNode);
                        return [4 /*yield*/, node.removeItem(id, beforeExecute, afterExecute)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        node = this.findNode(path);
                        (0, assert_1.assert)(node instanceof ListNode);
                        return [4 /*yield*/, node.updateItem(data, id, action, beforeExecute, afterExecute)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        node = this.findNode(path);
                        (0, assert_1.assert)(node instanceof ListNode);
                        return [4 /*yield*/, node.recoverItem(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        node = this.findNode(path);
                        (0, assert_1.assert)(node instanceof SingleNode);
                        return [4 /*yield*/, node.update(data, action, beforeExecute, afterExecute)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        node = this.findNode(path);
                        (0, assert_1.assert)(node instanceof SingleNode);
                        return [4 /*yield*/, node.remove(beforeExecute, afterExecute)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RunningTree.prototype.execute = function (path, data, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(node instanceof SingleNode)) return [3 /*break*/, 2];
                        return [4 /*yield*/, node.update(data, action)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "removeItem", null);
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "updateItem", null);
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "recoverItem", null);
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "create", null);
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "update", null);
    tslib_1.__decorate([
        Feature_1.Action
    ], RunningTree.prototype, "remove", null);
    tslib_1.__decorate([
        Feature_1.Action
