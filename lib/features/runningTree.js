...
function mergeOperationOper(entity, schema, from, into) {
    ...
    if (action === 'create') {
        ...
        if (into.action === 'create') {
            ...
            mergeOperationData(entity, schema, data, dataTo);
            if (action !== 'update') {
                (0, assert_1.assert)(into.action === 'update');
...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.checkIfClean = function () {
        ...
        if (this.isDirty()) {
            this.dirty = false;
            (_b = this.parent) === null || _b === void 0 ? void 0 : _b.checkIfClean();
        }
    };
    ListNode.prototype.onCacheSync = function (records) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var createdIds, records_1, records_1_1, record, a, _a, e, d, id, currentIds, _b, sorter, filter, filter2, value;
            var e_11, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _b = _d.sent(), sorter = _b.sorter, filter = _b.filter;
    ...
    ListNode.prototype.getFreshValue = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var projection, _a, createdIds, _b, _c, operation, oper, data, modies, operations, selection, filter, result;
            var e_13, _d;
            var _this = this;
                ...
                switch (_e.label) {
                    ...
                    case 4:
                        ...
                        if (modies.length === 0) {
                            ...
                            Object.assign(selection, {
                                filter: (0, filter_1.combineFilters)([filter, { id: { $in: createdIds } }], true),
                            });
                        }
    ...
    ListNode.prototype.doBeforeTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, operation, e_14_1, _c, _d, child, e_15_1;
            var e_14, _e, e_15, _f;
    ...
    ListNode.prototype.doAfterTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, operation, e_16_1, _c, _d, child, e_17_1;
            var e_16, _e, e_17, _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        try {
                            for (childOperations_1 = tslib_1.__values(childOperations), childOperations_1_1 = childOperations_1.next(); !childOperations_1_1.done; childOperations_1_1 = childOperations_1.next()) {
                                ...
                                if (oper) {
                                    ...
                                    try {
                                        for (eliminated_3 = (e_19 = void 0, tslib_1.__values(eliminated)), eliminated_3_1 = eliminated_3.next(); !eliminated_3_1.done; eliminated_3_1 = eliminated_3.next()) {
    ...
    ListNode.prototype.constructSelection = function (withParent) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, filters, sorters, disabled, data, sorterArr, filterArr, filterOfParent, filters2, filter;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        if (withParent && this.parent && !(this.parent instanceof VirtualNode)) {
                            (0, assert_1.assert)(this.parent instanceof SingleNode);
                            filterOfParent = this.parent.getParentFilter(this);
                            if (filterOfParent) {
    ...
    ListNode.prototype.refresh = function (pageNumber, getCount, append) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, entity, pagination, currentPage, pageSize, currentPage3, _b, projection, filter, sorter, disabled, _c, data, count, ids, err_1;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.constructSelection(true)];
                    case 1:
                        _b = _d.sent(), projection = _b.data, filter = _b.filter, sorter = _b.sorter, disabled = _b.disabled;
...
var SingleNode = /** @class */ (function (_super) {
    ...
    SingleNode.prototype.getFreshValue = function () {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var projection, _b, modies, operations, filter, result;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        this.id = (_a = result[0]) === null || _a === void 0 ? void 0 : _a.id;
    ...
    SingleNode.prototype.doAfterTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, operation, e_22_1, _c, _d, _i, k, child;
            var e_22, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
    ...
    SingleNode.prototype.getFilter = function () {
        ...
        if (this.id) {
            ...
            if (parent_1 && (parent_1 instanceof SingleNode || parent_1 instanceof ListNode)) {
                filter = parent_1.getParentFilter(this);
            }
        }
        if (!filter) {
            var _a = tslib_1.__read(this.operations, 1), operation = _a[0];
            if ((operation === null || operation === void 0 ? void 0 : operation.oper.action) === 'create') {
                var id = operation.oper.data.id;
                filter = {
                    id: id,
                };
            }
    ...
    SingleNode.prototype.refresh = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var projection, filter, _a, value, modi$entity, err_2;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    SingleNode.prototype.getParentFilter = function (childNode) {
        ...
        if (this.id) {
            ...
            if (parent_2 instanceof SingleNode || parent_2 instanceof ListNode) {
                filter = parent_2.getParentFilter(this);
            }
        }
        if (filter) {
                        ...
                        return {
                            id: {
                                $in: {
                                    ...
                                    filter: tslib_1.__assign({ entity: key }, filter),
                                },
                            },
                        };
                    }
...
var VirtualNode = /** @class */ (function () {
    ...
    VirtualNode.prototype.getModies = function (child) {
        return [];
    };
...
function repairOperations(entity, schema, operations) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        var operations_1, operations_1_1, operation, _a, data, data_1, data_1_1, d, e_24_1, e_25_1;
        var e_25, _b, e_24, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 4:
                    ...
                    data_1 = (e_24 = void 0, tslib_1.__values(data)), data_1_1 = data_1.next();
                    _d.label = 5;
                case 5:
...
var RunningTree = /** @class */ (function (_super) {
    ...
    RunningTree.prototype.destroyNode = function (path) {
        ...
        if (node) {
            ...
            var parent_3 = node.getParent();
            if (parent_3 instanceof SingleNode) {
                parent_3.removeChild(childPath);
            }
            else if (parent_3 instanceof ListNode) {
                parent_3.removeChild(childPath);
            }
            else if (!parent_3) {
