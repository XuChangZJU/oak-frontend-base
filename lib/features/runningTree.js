...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getFreshValue = function (context) {
        ...
        var finalIds = result.filter(function (ele) { var _a; return ele.$$createAt$$ === 1 || ((_a = _this.ids) === null || _a === void 0 ? void 0 : _a.includes(ele.id)); }).map(function (ele) { return ele.id; });
