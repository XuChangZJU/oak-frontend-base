...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getFreshValue = function (context) {
         ...
         */
        var _a = this.constructSelection(true, context, true), data = _a.data, filter = _a.filter;
        ...
        var r2 = result.filter(function (ele) { var _a; return ele.$$createAt$$ === 1 || ((_a = _this.ids) === null || _a === void 0 ? void 0 : _a.includes(ele.id)); }).sort(function (ele1, ele2) {
            if (ele1.$$createAt$$ === 1) {
                return -1;
            }
        ...
        if (this.aggr) {
            ...
            this.aggr.forEach(function (ele, idx) {
                ...
                var row = r2.find(function (ele) { return ele.id === id; });
                (0, assert_1.assert)(id);
