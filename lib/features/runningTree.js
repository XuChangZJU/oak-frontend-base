            ...
            return tslib_1.__generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 2:
                        ...
                        uds.push(ud2);
                        try {
                            for (_a = (e_5 = void 0, tslib_1.__values(this.children)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                child = _b.value;
                        ...
                        try {
                            for (_c = (e_6 = void 0, tslib_1.__values(this.newBorn)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                child = _d.value;
                                if (this.judgeTheSame(child.getFreshValue(true), ud2)) {
                                    existed = true;
                                    break;
                    ...
                    case 8:
                        try {
                            for (_e = tslib_1.__values(this.children), _f = _e.next(); !_f.done; _f = _e.next()) {
                                child = _f.value;
                                included = false;
                                try {
                                    for (uds_1 = (e_8 = void 0, tslib_1.__values(uds)), uds_1_1 = uds_1.next(); !uds_1_1.done; uds_1_1 = uds_1.next()) {
                                        ud = uds_1_1.value;
                        ...
                        try {
                            for (_g = tslib_1.__values(this.newBorn), _h = _g.next(); !_h.done; _h = _g.next()) {
                                child = _h.value;
                                try {
                                    for (uds_2 = (e_10 = void 0, tslib_1.__values(uds)), uds_2_1 = uds_2.next(); !uds_2_1.done; uds_2_1 = uds_2.next()) {
                                        ud = uds_2_1.value;
                                        if (this.judgeTheSame(child.getFreshValue(true), ud)) {
                                            newBorn2.push(child);
                                            break;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 2:
                        try {
                            for (_c = tslib_1.__values(this.children), _d = _c.next(); !_d.done; _d = _c.next()) {
                                child = _d.value;
                                if (this.judgeTheSame(child.getFreshValue(true), updateData)) {
                                    (0, assert_1.assert)(child.getAction() !== 'remove');
                                    // 这里把updateData全干掉了，如果本身是先update再remove或许会有问题 by Xc
