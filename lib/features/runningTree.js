...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getMyId = function (child) {
        var e_10, _a;
        var idx = 0;
        try {
            for (var _b = tslib_1.__values(this.children), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    ListNode.prototype.setLoading = function (loading) {
        ...
        this.children.forEach(function (ele) { return ele.setLoading(loading); });
    };
    ...
    ListNode.prototype.getFreshValue = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var createdIds, _a, _b, operation, oper, data, modies, operations, selection, filter, result;
            var e_14, _c;
            var _this = this;
    ...
    ListNode.prototype.doAfterTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, operation, e_17_1, _c, _d, child, e_18_1;
            var e_17, _e, e_18, _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        try {
                            for (childOperations_1 = tslib_1.__values(childOperations), childOperations_1_1 = childOperations_1.next(); !childOperations_1_1.done; childOperations_1_1 = childOperations_1.next()) {
                                ...
                                if (oper) {
                                    ...
                                    try {
                                        for (eliminated_3 = (e_20 = void 0, tslib_1.__values(eliminated)), eliminated_3_1 = eliminated_3.next(); !eliminated_3_1.done; eliminated_3_1 = eliminated_3.next()) {
    ...
    ListNode.prototype.constructSelection = function (withParent) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, filters, sorters, data, sorterArr, filterArr, filterOfParent, filters2, filter;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        filterArr = _b.sent();
                        if (!(withParent && this.parent && !(this.parent instanceof VirtualNode))) return [3 /*break*/, 5];
    ...
    ListNode.prototype.refresh = function (pageNumber, getCount, append) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, entity, pagination, currentPage, pageSize, currentPage3, _b, projection, filter, sorter, _c, data, count, ids, err_1;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.constructSelection(true)];
                    case 1:
                        _b = _d.sent(), projection = _b.data, filter = _b.filter, sorter = _b.sorter;
                        _d.label = 2;
                    case 2:
                        _d.trys.push([2, 4, , 5]);
...
var SingleNode = /** @class */ (function (_super) {
    ...
    SingleNode.prototype.getFreshValue = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var projection, _a, modies, operations, filter, createOper, result;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    SingleNode.prototype.doAfterTrigger = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, operation, e_23_1, _c, _d, _i, k, child;
            var e_23, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
...
function repairOperations(entity, schema, operations) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        var operations_1, operations_1_1, operation, _a, data, data_1, data_1_1, d, e_25_1, e_26_1;
        var e_26, _b, e_25, _c;
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 4:
                    ...
                    data_1 = (e_25 = void 0, tslib_1.__values(data)), data_1_1 = data_1.next();
                    _d.label = 5;
                case 5:
