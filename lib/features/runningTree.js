...
function translateAuthItemToProjection(schema, entity, item, userId, prefix) {
    ...
    var makeUserEntityProjection = function (entity2) {
        ...
        var projection = (_a = {
            ...
            _a["user".concat((0, string_1.firstLetterUpperCase)(entity2), "$").concat(entity2)] = {
        ...
        if (!into[attr]) {
            ...
            if (rel === 2) {
                ...
                var mergeInner = function (item) {
                    ...
                    try {
                        for (var eliminated_1 = (e_4 = void 0, tslib_1.__values(eliminated)), eliminated_1_1 = eliminated_1.next(); !eliminated_1_1.done; eliminated_1_1 = eliminated_1.next()) {
                ...
                if (from[attr] instanceof Array) {
                    try {
                        for (var _c = (e_3 = void 0, tslib_1.__values(from[attr])), _d = _c.next(); !_d.done; _d = _c.next()) {
        ...
        for (var existed_1 = tslib_1.__values(existed), existed_1_1 = existed_1.next(); !existed_1_1.done; existed_1_1 = existed_1.next()) {
            ...
            if (action === toOperation.action) {
                ...
                if (action === 'update' && toOperation.action === 'create') {
                    ...
                    if (operData instanceof Array) {
                        try {
                            for (var operData_3 = (e_8 = void 0, tslib_1.__values(operData)), operData_3_1 = operData_3.next(); !operData_3_1.done; operData_3_1 = operData_3.next()) {
                    ...
                    if (toOperation.action === 'create') {
                        ...
                        if (operData instanceof Array) {
                            try {
                                for (var operData_4 = (e_9 = void 0, tslib_1.__values(operData)), operData_4_1 = operData_4.next(); !operData_4_1.done; operData_4_1 = operData_4.next()) {
...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getFreshValue = function () {
        ...
        var operations = modies
            ? (0, modi_1.createOperationsFromModies)(modies)
            : [];
        // 所有的子结点将数据应用到最新
        ...
        Object.keys(this.updates).forEach(function (id) {
            if (!_this.children[id]) {
                operations.push({
                    entity: _this.entity,
                    operation: _this.updates[id].operation,
                });
            }
        });
    ...
    ListNode.prototype.constructFilters = function (withParent) {
    ...
    ListNode.prototype.constructSelection = function (withParent) {
        ...
        var _a = this.constructFilters(withParent), validParentFilter = _a.validParentFilter, filters = _a.filters;
        var filters2 = filters.filter(function (ele) { return !!ele; });
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(validParentFilter && projection)) return [3 /*break*/, 4];
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
    ...
    ListNode.prototype.getIntrinsticFilters = function () {
        var filters = this.constructFilters().filters;
...
var SingleNode = /** @class */ (function (_super) {
    ...
    function SingleNode(entity, schema, cache, authDict, projection, parent, path, id, actions, cascadeActions) {
        ...
        _this.children = {};
        _this.id = id;
        if (_this.isCreatedByParent()) {
            // 这样说明是父结点（ListNode）创建的本结点，置dirty就行了
            _this.setDirty();
        }
        else if (!_this.getFilter()) {
            // 没有任何的filter，是创建动作
            _this.create({});
        }
        return _this;
    }
    SingleNode.prototype.isCreatedByParent = function () {
        var parent = this.getParent();
        if (parent instanceof ListNode) {
            var operation = parent.getChildOperation(this);
            if ((operation === null || operation === void 0 ? void 0 : operation.action) === 'create') {
                return true;
            }
        }
        return false;
    ...
    SingleNode.prototype.getId = function () {
        ...
        var value = this.getFreshValue(true);
    ...
    SingleNode.prototype.getFreshValue = function (noCascade) {
        ...
        if (filter && projection) {
            ...
            var operations2 = this.composeOperations(noCascade);
            if (operations2) {
                operations.push.apply(operations, tslib_1.__spreadArray([], tslib_1.__read(operations2), false));
            }
    ...
    SingleNode.prototype.isCreation = function () {
        var _a;
        var operations = this.composeOperations(true);
        // 如果是create，一定在第一个
    ...
    SingleNode.prototype.composeOperations = function (noCascade) {
        var _a, _b;
        if (!this.dirty) {
            return;
        }
        ...
        var parent = this.getParent();
        if (parent instanceof ListNode) {
            var parentOperation = parent.getChildOperation(this);
            if (parentOperation) {
                ...
                if (rel === 2) {
                    ...
                    if (value) {
                        ...
                        if (value === null || value === void 0 ? void 0 : value.entityId) {
                            (0, assert_1.assert)((value === null || value === void 0 ? void 0 : value.entity) === this.children[key].getEntity());
                            return {
                                id: value.entityId,
                            };
                        }
                    ...
                    if (rel[1]) {
                        ...
                        if (filter) {
                            ...
                            return _d = {},
                                _d[rel[1].slice(0, rel[1].length - 2)] = filter,
                                _d;
                        }
                    }
                    else {
        ...
        if (this.findNode(fullPath)) {
            ...
            if (node_1 instanceof ListNode) {
                ...
                if (!node_1.getProjection() && projection) {
                    ...
                    (0, assert_1.assert)(false, "\u521B\u5EFAnode\u65F6\u53D1\u73B0path[".concat(fullPath, "]\u5DF2\u7ECF\u5B58\u5728\u6709\u6548\u7684ListNod\u7ED3\u70B9\uFF0C\u8FD9\u79CD\u60C5\u51B5\u4E0D\u5E94\u8BE5\u5B58\u5728"));
                }
            }
                ...
                if (!node_1.getProjection() && projection) {
                    ...
                    (0, assert_1.assert)(parentNode instanceof ListNode, "\u521B\u5EFAnode\u65F6\u53D1\u73B0path[".concat(fullPath, "]\u5DF2\u6709\u6709\u6548\u7684SingleNode\u7ED3\u70B9\uFF0C\u672C\u60C5\u51B5\u4E0D\u5E94\u5F53\u5B58\u5728"));
                }
            }
            else {
                (0, assert_1.assert)(false, "\u521B\u5EFAnode\u65F6\u53D1\u73B0path[".concat(fullPath, "]\u5DF2\u6709\u6709\u6548\u7684VirtualNode\u7ED3\u70B9\uFF0C\u672C\u60C5\u51B5\u4E0D\u5E94\u5F53\u5B58\u5728"));
            }
            return node_1;
        }
        if (entity) {
