...
var ListNode = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        currentIds = this.children.map(function (ele) { var _a; return (_a = ele.getFreshValue()) === null || _a === void 0 ? void 0 : _a.id; }).filter(function (ele) { return !!ele; });
    ...
    ListNode.prototype.setValue = function (value) {
        var _this = this;
        this.children = [];
        value && value.forEach(function (ele, idx) {
    ...
    ListNode.prototype.getFreshValue = function () {
        var _this = this;
        var value = this.children.map(function (ele) { return ele.getFreshValue(); }).concat(this.newBorn.map(function (ele) { return ele.getFreshValue(); })).filter(function (ele) { return !!ele; });
        if (this.isDirty()) {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.cache.refresh(entity, {
                                data: proj,
                                filter: filterss.length > 0 ? (0, filter_1.combineFilters)(filterss.filter(function (ele) { return !!ele; })) : undefined,
                                sorter: sorterss,
                                indexFrom: 0,
                                count: step,
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this, filters = _a.filters, sorters = _a.sorters, pagination = _a.pagination, entity = _a.entity;
                        step = pagination.step, more = pagination.more;
                        if (!more) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.getProjection()];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, Promise.all(value.map(function (row) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                            ...
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    ...
                                    case 5:
                                        ...
                                        if (!(relation === 2 &&
                                            (actionData.hasOwnProperty('entity') || actionData.hasOwnProperty('entityId')))) return [3 /*break*/, 7];
                                    ...
                                    case 6:
                                        ...
                                        return [3 /*break*/, 9];
                                    case 7:
                                        if (!(typeof relation === 'string' && actionData.hasOwnProperty("".concat(attr, "Id")))) return [3 /*break*/, 9];
