...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.getIntrinsticData = function () {
        var _this = this;
        var data = {};
        ...
        var checkFilter = function (filter) {
            ...
            for (var key in filter) {
                if (_this.schema[_this.entity].attributes[key] && typeof filter[key] !== 'object') {
                    (0, assert_1.assert)(!data[key] || data[key] === filter[key]);
...
var RunningTree = /** @class */ (function (_super) {
    ...
    RunningTree.prototype.getIntrinsticData = function (path) {
        var node = this.findNode(path);
        (0, assert_1.assert)(node instanceof ListNode);
