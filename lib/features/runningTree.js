...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.constructSelection = function (withParent) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, filters, sorters, disabled, data, sorterArr, filterArr, filterOfParent;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ListNode.prototype.refresh = function (pageNumber, getCount, append) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, entity, pagination, currentPage, pageSize, currentPage3, _b, projection, filters, sorter, disabled, _c, data, count, ids, err_1;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.constructSelection(true)];
                    case 1:
                        _b = _d.sent(), projection = _b.data, filters = _b.filters, sorter = _b.sorter, disabled = _b.disabled;
