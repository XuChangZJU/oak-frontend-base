...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.setUniqueChildren = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var convertForeignKey, uds, data_1, data_1_1, dt, existed, updateData, ud2, _a, _b, child, _c, _d, child, e_4_1, _e, _f, child, included, uds_1, uds_1_1, ud, newBorn2, _g, _h, child, uds_2, uds_2_1, ud;
            var e_4, _j, e_5, _k, e_6, _l, e_7, _m, e_8, _o, e_9, _p, e_10, _q;
            var _this = this;
            return __generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 2:
                        ...
                        uds.push(ud2);
                        try {
                            for (_a = (e_5 = void 0, __values(this.children)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                child = _b.value;
                        ...
                        try {
                            for (_c = (e_6 = void 0, __values(this.newBorn)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                child = _d.value;
                                if (this.judgeTheSame(child.getFreshValue(true), ud2)) {
                                    existed = true;
                                    break;
                    ...
                    case 8:
                        try {
                            for (_e = __values(this.children), _f = _e.next(); !_f.done; _f = _e.next()) {
                                child = _f.value;
                                included = false;
                                try {
                                    for (uds_1 = (e_8 = void 0, __values(uds)), uds_1_1 = uds_1.next(); !uds_1_1.done; uds_1_1 = uds_1.next()) {
                                        ud = uds_1_1.value;
                        ...
                        newBorn2 = [];
                        try {
                            for (_g = __values(this.newBorn), _h = _g.next(); !_h.done; _h = _g.next()) {
                                child = _h.value;
                                try {
                                    for (uds_2 = (e_10 = void 0, __values(uds)), uds_2_1 = uds_2.next(); !uds_2_1.done; uds_2_1 = uds_2.next()) {
                                        ud = uds_2_1.value;
                                        if (this.judgeTheSame(child.getFreshValue(true), ud)) {
                                            newBorn2.push(child);
                                            break;
    ...
    ListNode.prototype.toggleChild = function (data, checked) {
        return __awaiter(this, void 0, void 0, function () {
            var updateData, _a, _b, child, _c, _d, child, _e, _f, child;
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 2:
                        ...
                        try {
                            for (_e = __values(this.newBorn), _f = _e.next(); !_f.done; _f = _e.next()) {
                                child = _f.value;
                                if (this.judgeTheSame(child.getFreshValue(true), updateData)) {
...
var RunningTree = /** @class */ (function (_super) {
    ...
    RunningTree.prototype.setUpdateDataInner = function (path, attr, value) {
        return __awaiter(this, void 0, void 0, function () {
            var node, attrSplit, idx, attrSplit_1, attrSplit_1_1, split, idx2, entity, relation, attrName, e_16_1;
            var e_16, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        attrSplit_1 = __values(attrSplit), attrSplit_1_1 = attrSplit_1.next();
                        _b.label = 2;
                    case 2:
    ...
    RunningTree.prototype.addForeignKeys = function (parent, attr, ids) {
        return __awaiter(this, void 0, void 0, function () {
            var parentNode, ids_1, ids_1_1, id, node, e_17_1;
            var e_17, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    RunningTree.prototype.testAction = function (path, action, execute) {
        return __awaiter(this, void 0, void 0, function () {
            var node, operation, operation_2, operation_2_1, oper, e_18_1;
            var e_18, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    RunningTree.prototype.beforeExecute = function (node2, action) {
        return __awaiter(this, void 0, void 0, function () {
            function beNode(node, action2) {
                return __awaiter(this, void 0, void 0, function () {
                    var beforeExecuteFn, _a, _b, child, e_19_1, _c, _d, child, e_20_1, _e, _f, _i, k;
                    var e_19, _g, e_20, _h;
