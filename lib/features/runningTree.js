            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        operations = (0, lodash_1.cloneDeep)(this.operations);
                        try {
                            for (childOperations_1 = tslib_1.__values(childOperations), childOperations_1_1 = childOperations_1.next(); !childOperations_1_1.done; childOperations_1_1 = childOperations_1.next()) {
                                ...
                                if (oper) {
                                    merged = this.operations.length > 0 && tryMergeOperationToExisted(this.entity, this.schema, oper[0], operations);
                                    if (!merged) {
...
var SingleNode = /** @class */ (function (_super) {
    ...
    SingleNode.prototype.composeOperations = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var childOperations, operations, _a, _b, _c, _d, childOperations_2, childOperations_2_1, oper, merged;
            var _e, _f, _g, _h, e_13, _j;
            var _this = this;
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                                            ...
                                            if (childOperations) {
                                                if (child instanceof SingleNode) {
                                                    ...
                                                    subBe = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                        var childOperations_3, childOperations_3_1, o, _a, e_14_1;
                                                        var e_14, _b;
                                                        return tslib_1.__generator(this, function (_c) {
                                                            switch (_c.label) {
                                                                case 0:
                                                    ...
                                                    subAe = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                        var childOperations_4, childOperations_4_1, o, _a, e_15_1;
                                                        var e_15, _b;
                                                        return tslib_1.__generator(this, function (_c) {
                                                            switch (_c.label) {
                                                                case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, generateNewId()];
                    case 3:
                        _b.apply(_a, [(_e.oper = (_f.id = _k.sent(),
                                _f.action = 'update',
                                _f.data = {},
                                _f.filter = {
                                    id: this.id,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, generateNewId()];
                    case 5:
                        _d.apply(_c, [(_g.oper = (_h.id = _k.sent(),
                                _h.action = 'create',
                                _h.data = {},
                                _h),
                                _g)]);
                    ...
                    case 6:
                        try {
                            for (childOperations_2 = tslib_1.__values(childOperations), childOperations_2_1 = childOperations_2.next(); !childOperations_2_1.done; childOperations_2_1 = childOperations_2.next()) {
                                ...
                                if (oper) {
                                    merged = tryMergeOperationToExisted(this.entity, this.schema, oper, operations);
                            ...
                            try {
                                if (childOperations_2_1 && !childOperations_2_1.done && (_j = childOperations_2.return)) _j.call(childOperations_2);
                            }
...
var RunningTree = /** @class */ (function (_super) {
    ...
    RunningTree.prototype.execute = function (path) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var node, operations, operations_1, operations_1_1, operation, _a, e_16_1, operations_2, operations_2_1, operation, _b, e_17_1, err_3;
            var e_16, _c, e_17, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        _e.label = 4;
                    case 4:
                        if (!!operations_1_1.done) return [3 /*break*/, 8];
                    ...
                    case 13:
                        ...
                        _e.label = 14;
                    case 14:
                        if (!!operations_2_1.done) return [3 /*break*/, 18];
                    ...
                    case 20:
                        try {
                            if (operations_2_1 && !operations_2_1.done && (_d = operations_2.return)) _d.call(operations_2);
                        }
                    ...
                    case 21:
                        ...
                        return [2 /*return*/, operations.map(function (ele) { return ele.oper; })];
                    case 22:
                        err_3 = _e.sent();
                        node.setExecuting(false);
                        throw err_3;
