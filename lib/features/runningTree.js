...
var SingleNode = /** @class */ (function (_super) {
    ...
    function SingleNode(entity, schema, cache, projection, projectionShape, parent, action, updateData) {
        ...
        var hasModi = attrs.includes('modi$entity');
    ...
    SingleNode.prototype.setValue = function (value) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var value2, attrs, entityOperations, _a, projection, id, entity, projection2, _b, result, attr, attrs_1, attrs_1_1, attr, node, rel, filter, e_17_1;
            var _c, e_17, _d, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (!value2.modi$entity) return [3 /*break*/, 5];
                    ...
                    case 4:
                        ...
                        for (attr in value2) {
                            if (attr !== 'modi$entity' && this.children[attr]) {
                                ...
                                Object.assign(value2, (_c = {},
                                    _c[attr] = result[0][attr],
                                    _c["".concat(attr, ":prev")] = value2[attr],
                                    _c));
                            }
                        }
                        _f.label = 5;
                    ...
                    case 13:
                        try {
                            if (attrs_1_1 && !attrs_1_1.done && (_d = attrs_1.return)) _d.call(attrs_1);
                        }
