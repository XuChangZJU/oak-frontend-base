...
var ListNode = /** @class */ (function (_super) {
    ...
    ListNode.prototype.setUniqueChildren = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var convertForeignKey, uds, data_1, data_1_1, dt, existed, updateData, ud2, _a, _b, child, _c, _d, child, e_5_1, _e, _f, child, included, uds_1, uds_1_1, ud, e_6_1, newBorn2, _g, _h, child, uds_2, uds_2_1, ud;
            var e_5, _j, e_7, _k, e_8, _l, e_6, _m, e_9, _o, e_10, _p, e_11, _q;
            var _this = this;
            return tslib_1.__generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 2:
                        ...
                        uds.push(ud2);
                        try {
                            for (_a = (e_7 = void 0, tslib_1.__values(this.children)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                child = _b.value;
                        ...
                        try {
                            for (_c = (e_8 = void 0, tslib_1.__values(this.newBorn)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                child = _d.value;
                                if (this.judgeTheSame(child.getFreshValue(true), ud2)) {
                                    existed = true;
                                    break;
                    ...
                    case 9:
                        ...
                        included = false;
                        try {
                            for (uds_1 = (e_9 = void 0, tslib_1.__values(uds)), uds_1_1 = uds_1.next(); !uds_1_1.done; uds_1_1 = uds_1.next()) {
                                ud = uds_1_1.value;
                    ...
                    case 15:
                        ...
                        try {
                            for (_g = tslib_1.__values(this.newBorn), _h = _g.next(); !_h.done; _h = _g.next()) {
                                child = _h.value;
                                try {
                                    for (uds_2 = (e_11 = void 0, tslib_1.__values(uds)), uds_2_1 = uds_2.next(); !uds_2_1.done; uds_2_1 = uds_2.next()) {
                                        ud = uds_2_1.value;
                                        if (this.judgeTheSame(child.getFreshValue(true), ud)) {
                                            newBorn2.push(child);
                                            break;
    ...
    ListNode.prototype.toggleChild = function (data, checked) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var updateData, _a, _b, child, _c, _d, child, e_12_1, _e, _f, child;
            var e_13, _g, e_12, _h, e_14, _j;
                ...
                switch (_k.label) {
                    case 0:
                        ...
                        try {
                            ...
                            for (_a = tslib_1.__values(this.children), _b = _a.next(); !_b.done; _b = _a.next()) {
                                child = _b.value;
                        ...
                        return [4 /*yield*/, this.pushNewBorn(data)];
                    case 1:
                        _k.sent();
                        return [3 /*break*/, 10];
                    case 2:
                    ...
                    case 3:
                        ...
                        child = _d.value;
                        if (!this.judgeTheSame(child.getFreshValue(true), updateData)) return [3 /*break*/, 5];
                        (0, assert_1.assert)(child.getAction() !== 'remove');
                        // 这里把updateData全干掉了，如果本身是先update再remove或许会有问题 by Xc
                        return [4 /*yield*/, child.setAction('remove')];
                    case 4:
    ...
    SingleNode.prototype.setForeignKey = function (attr, entity, id) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.children[attr]) return [3 /*break*/, 8];
                        if (!(typeof this.projection === 'function')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.projection()];
                    case 1:
                        _a = _b.sent();
...
var RunningTree = /** @class */ (function (_super) {
    ...
    RunningTree.prototype.applyOperation = function (entity, value, operation, projection, scene) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _loop_1, this_1, operation_1, operation_1_1, action, e_16_1, action, data, applyUpsert, _a;
            var e_16, _b;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
    ...
    RunningTree.prototype.setUpdateDataInner = function (path, attr, value) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var node, attrSplit, idx, attrSplit_1, attrSplit_1_1, split, idx2, entity, relation, attrName, e_17_1;
            var e_17, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    RunningTree.prototype.addForeignKeys = function (parent, attr, ids) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var parentNode, ids_1, ids_1_1, id, node, e_18_1;
            var e_18, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    RunningTree.prototype.testAction = function (path, action, execute) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var node, operation, operation_2, operation_2_1, oper, e_19_1;
            var e_19, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    RunningTree.prototype.beforeExecute = function (node2, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            function beNode(node, action2) {
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    var beforeExecuteFn, _a, _b, child, e_20_1, _c, _d, child, e_21_1, _e, _f, _i, k;
                    var e_20, _g, e_21, _h;
