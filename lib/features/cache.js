...
var Cache = /** @class */ (function (_super) {
    ...
    function Cache(aspectWrapper, context, cacheStore) {
        ...
        aspectWrapper.exec = function (name, params) { return __awaiter(_this, void 0, void 0, function () {
    ...
    Cache.prototype.sync = function (records) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cacheStore.sync(records, this.context)];
                    case 1:
                        _a.sent();
    ...
    Cache.prototype.get = function (entity, selection, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cacheStore.select(entity, selection, this.context, params)];
                    case 1:
                        result = (_a.sent()).result;
                        return [2 /*return*/, result];
                }
