...
var Locales = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (newI18ns.length > 0) {
                            ...
                            console.warn("\u547D\u540D\u7A7A\u95F4".concat(ns, "\u4E2D\u7684").concat(key, "\u7F3A\u5931\u4E14\u53EF\u80FD\u8BF7\u6C42\u4E0D\u5230\u66F4\u65B0\u7684\u6570\u636E\uFF0C\u8BF7\u68C0\u67E5"));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    Locales.prototype.t = function (key, params) {
        ...
        var ns = params['#oakNamespace'];
        var module = params['#oakModule'];
        var key2 = key;
        if (key.includes('::')) {
            // 公共模块
            key2 = "".concat(module, "-l-").concat(key).replace('::', '.');
        }
