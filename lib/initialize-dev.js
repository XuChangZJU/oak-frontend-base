 ...
 * @returns
 */
function initialize(storageSchema, frontendContextBuilder, backendContextBuilder, aspectDict, triggers, checkers, watchers, timers, startRoutines, initialData, actionDict, authDict, relationDict, colorDict, importations, exportations) {
    var _this = this;
    ...
    var features = (0, features_1.initialize)(wrapper, storageSchema, function () { return frontendContextBuilder()(cacheStore); }, cacheStore, relationDict || {}, authDict || {}, colorDict || {});
