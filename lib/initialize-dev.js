 ...
 * @returns
 */
function initialize(storageSchema, frontendContextBuilder, backendContextBuilder, aspectDict, triggers, checkers, watchers, timers, startRoutines, initialData, actionDict, actionCascadePathGraph, relationCascadePathGraph, cascadeRemoveDict, colorDict, importations, exportations) {
    var _this = this;
    ...
    var features = (0, features_1.initialize)(wrapper, storageSchema, function () { return frontendContextBuilder()(cacheStore); }, cacheStore, actionCascadePathGraph || [], relationCascadePathGraph || [], colorDict || {});
