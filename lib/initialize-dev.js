...
function initialize(storageSchema, createFeatures, contextBuilder, aspectDict, triggers, checkers, watchers, initialData, actionDict) {
    ...
    var checkers2 = (0, index_1.createCheckers)(storageSchema).concat(checkers || []);
    var debugStore = (0, debugStore_1.createDebugStore)(storageSchema, contextBuilder, triggers || [], checkers2, watchers || [], initialData, actionDict);
    var cacheStore = new CacheStore_1.CacheStore(storageSchema, contextBuilder, function () { return debugStore; }, function () { return (0, debugStore_1.clearMaterializedData)(); });
