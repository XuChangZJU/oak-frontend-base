...
var oakBehavior = Behavior({
    methods: {
        ...
        onReachBottom: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(!this.state.oakLoadingMore && this.iAmThePage() && this.option.isList)) return [3 /*break*/, 2];
        ...
        navigateBack: function (option) {
            return this.features.navigator.navigateBack(option === null || option === void 0 ? void 0 : option.delta);
        },
        navigateTo: function (option, state) {
            var url = option.url, rest = tslib_1.__rest(option, ["url"]);
            return this.features.navigator.navigateTo(url, tslib_1.__assign(tslib_1.__assign({}, state), rest));
        },
        redirectTo: function (option, state) {
            var url = option.url, rest = tslib_1.__rest(option, ["url"]);
            return this.features.navigator.redirectTo(url, tslib_1.__assign(tslib_1.__assign({}, state), rest));
        },
        addOperation: function (operation, beforeExecute, afterExecute, path) {
        ...
        setUpdateData: function (attr, data) {
            return page_common_1.setUpdateData.call(this, attr, data);
        },
        setMultiAttrUpdateData: function (data) {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    if (this.state.oakFullpath) {
                        filter = this.features.runningTree.getNamedFilterByName(this.state.oakFullpath, name);
    ...
    observers: {
        ...
        oakId: function (data) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.setId(data)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
