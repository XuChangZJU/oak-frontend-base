...
function makeCommonComponentMethods(features, formData) {
...
function createPage(options, features) {
    ...
    return Component({
        ...
        methods: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ setState: function (data, callback) {
                var _this = this;
            ...
            } }, hiddenMethods), commonMethods), listMethods), onlyMethods), restPageMethods), (methods
...
function createComponent(options, features) {
    ...
    var hiddenMethods = (0, page_common_1.makeHiddenComponentMethods)();
    var commonMethods = makeCommonComponentMethods(features, formData);
    var listMethods = (0, page_common_1.makeListComponentMethods)(features);
    var onlyMethods = (0, page_common_1.makeComponentOnlyMethods)(formData, entity, actions);
    return Component(tslib_1.__assign({ data: Object.assign({}, data, {
            ...
            } }, hiddenMethods), commonMethods), listMethods), onlyMethods), methods), lifetimes: {
            created: function () {
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    var setData;
                    var _this = this;
