...
export declare type ExceptionHandlerDict<ED extends EntityDict & BaseEntityDict, Cxt extends AsyncContext<ED>, FrontCxt extends SyncContext<ED>, AD extends Record<string, Aspect<ED, Cxt>>, FD extends Record<string, Feature>> = Record<string, ExceptionHandler<ED, Cxt, FrontCxt, AD, FD>>;
