...
exports.default = OakComponent({
    ...
    formData: function (_a) {
        ...
        Object.keys($actionAuthsObject).forEach(function (ele) {
            ...
            var slicePath = entities[entities.length - 1];
            var se = entities[entities.length - 1].split('$')[0];
            var relationEntity = _this.resolveP(schema, ele, entity);
            var p = ele;
            var de = entity;
            ...
            if (relationEntity === 'user') {
                ...
                relations = _this.features.cache.get('relation', {
                    data: {
                        id: 1,
                        entity: 1,
                        entityId: 1,
    ...
    methods: {
        ...
        resolveP: function (schema, path, destEntity) {
            if (path === '') {
                return destEntity;
            }
