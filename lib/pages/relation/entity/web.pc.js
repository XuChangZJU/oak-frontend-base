...
function render(props) {
    ...
    //     );
    // }
    var ActionSelector = actions && ((0, jsx_runtime_1.jsxs)(antd_1.Row, { style: { width: '100%' }, justify: "center", align: "middle", children: [(0, jsx_runtime_1.jsxs)(Text, { strong: true, children: [t('action'), ":"] }), (0, jsx_runtime_1.jsx)(antd_1.Row, { style: { flex: 1, marginLeft: 10 }, justify: "start", align: "middle", wrap: true, children: (0, jsx_runtime_1.jsx)(antd_1.Checkbox.Group, { options: actions, value: checkedActions, onChange: function (value) { return onActionsSelected(value); }, style: {
                        display: 'flex',
                        flexWrap: 'wrap',
                    } }) })] }));
    var RelationSelector = relations && ((0, jsx_runtime_1.jsxs)(antd_1.Row, { style: { width: '100%' }, justify: "center", align: "middle", children: [(0, jsx_runtime_1.jsxs)(Text, { strong: true, children: [t('relation'), ":"] }), (0, jsx_runtime_1.jsx)(antd_1.Row, { style: { flex: 1, marginLeft: 10 }, justify: "start", align: "middle", wrap: true, children: (0, jsx_runtime_1.jsx)(antd_1.Checkbox.Group, { options: relations.map(function (ele) { return ({ label: ele.name, value: ele.id }); }), value: relationIds, onChange: function (value) { return onRelationsSelected(value); }, style: {
                        display: 'flex',
                        flexWrap: 'wrap',
                    } }) })] }));
