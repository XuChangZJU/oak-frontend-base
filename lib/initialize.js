...
function createAspectProxy(storageSchema, createContext, triggers, checkers, features, aspectDict, initialData) {
    if (process.env.NODE_ENV === 'production') {
        ...
        // todo initialData
        const debugStore = (0, debugStore_1.createDebugStore)(storageSchema, createContext, triggers, checkers, initialData);
...
function initialize(storageSchema, createFeatures, createContext, triggers, checkers, aspectDict, initialData) {
    ...
    const aspectProxy = createAspectProxy(storageSchema, createContext, triggers || [], checkers || [], features, aspectDict, initialData);
