...
function render(props) {
    var _this = this;
    var _a = props.data, pickerRender = _a.pickerRender, renderValue = _a.renderValue, data = _a.data, multiple = _a.multiple, onChange = _a.onChange, entityIds = _a.entityIds, placeholder = _a.placeholder, schema = _a.schema;
    ...
    if (!data && mode !== 'list') {
        ...
        switch (mode) {
            case 'select': {
                ...
                return ((0, jsx_runtime_1.jsx)(antd_1.Select, { placeholder: placeholder, mode: multiple ? 'multiple' : undefined, value: multiple ? entityIds : entityId, onChange: function (value) {
            ...
            case 'list': {
                ...
                return ((0, jsx_runtime_1.jsxs)(antd_1.Space, { children: [(0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: placeholder, value: renderValue, allowClear: !required, onClick: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            ...
                            } }), (0, jsx_runtime_1.jsx)(antd_1.Modal, { title: "\u9009\u62E9".concat(t("".concat(pickerRender.entity, ":name"))), open: visibile, closable: true, onCancel: function () {
                                setDynamicFilter(undefined);
                                setDynamicProjection(undefined);
                                setDynamicSorter(undefined);
                                setVisible(false);
                            }, destroyOnClose: true, footer: null, children: (0, jsx_runtime_1.jsx)(picker_1.default, { multiple: false, oakPath: "$refAttr-picker-".concat(entity_1), entity: entity_1, title: title, titleLabel: titleLabel, oakFilters: dynamicFilter
                                    ? [
                                        {
