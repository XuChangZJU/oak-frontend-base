...
function render(props) {
    var _this = this;
    var _a = props.data, pickerRender = _a.pickerRender, renderValue = _a.renderValue, data = _a.data, multiple = _a.multiple, onChange = _a.onChange, entityIds = _a.entityIds, placeholder = _a.placeholder;
