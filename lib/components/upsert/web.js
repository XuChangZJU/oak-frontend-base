...
function makeAttrInput(attrRender, onValueChange, t, label) {
    ...
    switch (type) {
        ...
        case 'date': {
            ...
            return ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.DatePicker, { visible: dt, onClose: function () { return setDt(false); }, precision: precision, value: new Date(value), defaultValue: new Date(), min: min ? new Date(min) : undefined, max: max ? new Date(max) : undefined, children: function (value) { return (0, dayjs_1.default)(value).format(format_1); } }), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { onClick: function () { return setDt(true); }, children: type === 'date' ? t('chooseDate') : t('chooseDatetime') })] }));
        }
        case 'time': {
        ...
        case 'enum': {
            return ((0, jsx_runtime_1.jsx)(antd_mobile_1.Radio.Group, { value: value, onChange: function (value) { return onValueChange(value); }, children: enumeration.map(function (_a) {
                    var label = _a.label, value = _a.value;
                    return ((0, jsx_runtime_1.jsx)(antd_mobile_1.Radio, { value: value, children: t(label) }));
                }) }));
        }
        case 'ref': {
        ...
        case 'coordinate': {
            ...
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(antd_mobile_1.Popup, { closeOnMaskClick: true, destroyOnClose: true, position: 'bottom', visible: sl, onClose: function () { return setSl(false); }, bodyStyle: {
                            height: '100%',
                            display: 'flex',
                            flexDirection: 'column',
                            alignItems: 'stretch',
                        }, children: [(0, jsx_runtime_1.jsx)("div", { style: { flex: 1 }, children: (0, jsx_runtime_1.jsx)(location_1.default, { coordinate: coordinate, onLocated: function (poi) { return setPoi(poi); } }) }), (0, jsx_runtime_1.jsxs)(antd_mobile_1.Grid, { columns: 2, gap: 8, children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { block: true, color: "primary", disabled: !poi, onClick: function () {
                                            var _a;
                                            if (poi) {
                                            ...
                                            setSl(false);
                                        }, children: t('common::action.confirm') }), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { block: true, fill: "outline", onClick: function () {
                                            setSl(false);
...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(antd_mobile_1.Form, { layout: layout, mode: mode, children: renderData.map(function (ele) {
