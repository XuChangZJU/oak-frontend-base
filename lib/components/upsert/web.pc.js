...
function makeAttrInput(attrRender, onValueChange, t, label) {
    ...
    switch (type) {
        ...
        case 'enum': {
            return ((0, jsx_runtime_1.jsx)(antd_1.Radio.Group, { value: value, onChange: function (_a) {
                    var target = _a.target;
                    return onValueChange(target.value);
                }, children: enumeration.map(function (_a) {
                    var label = _a.label, value = _a.value;
                    return ((0, jsx_runtime_1.jsx)(antd_1.Radio, { value: value, children: t(label) }));
                }) }));
        }
        case 'ref': {
        ...
        case 'coordinate': {
            ...
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Modal, { width: "80vw", open: sl, closable: false, onCancel: function () { return setSl(false); }, okText: "\u786E\u8BA4", cancelText: "\u53D6\u6D88", okButtonProps: {
                            disabled: !poi,
                        }, onOk: function () {
                            var _a;
                            if (poi) {
                            ...
                            setSl(false);
                        }, children: (0, jsx_runtime_1.jsx)(location_1.default, { coordinate: coordinate, onLocated: function (poi) { return setPoi(poi); } }) }), (0, jsx_runtime_1.jsx)("div", { style: {
                            display: 'flex',
                            flexDirection: 'column',
                            width: '100%',
                        }, children: (0, jsx_runtime_1.jsxs)(antd_1.Space, { direction: "vertical", size: 8, children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { align: "center", children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "dashed", onClick: function () {
                                            setSl(true);
...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Form, { labelCol: { span: 4 }, layout: "horizontal", children: renderData.map(function (ele) {
