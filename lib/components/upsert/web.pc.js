...
function makeAttrInput(attrRender, onValueChange) {
    ...
    var _c = attrRender, value = _c.value, type = _c.type, label = _c.label, params = _c.params, defaultValue = _c.defaultValue, enumeration = _c.enumeration, required = _c.required, placeholder = _c.placeholder, min = _c.min, max = _c.max, maxLength = _c.maxLength;
    switch (type) {
        case 'string':
        case 'varchar':
        case 'char':
...
function render(props) {
    var _a = props.data, _b = _a.renderData, renderData = _b === void 0 ? [] : _b, helps = _a.helps;
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Form, tslib_1.__assign({ labelCol: { span: 4 }, layout: "horizontal", style: {
            ...
            ], help: helps && helps[ele.attr] }, { children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: makeAttrInput(ele, function (value, extra) {
                    var _a;
                    var attr = ele.attr;
