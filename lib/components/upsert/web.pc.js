...
function makeAttrInput(attrRender, onValueChange) {
    var value = attrRender.value, type = attrRender.type, params = attrRender.params, ref = attrRender.ref, label = attrRender.label, defaultValue = attrRender.defaultValue, required = attrRender.required;
    switch (type) {
        case 'string':
        case 'varchar':
        case 'char': {
...
function render(props) {
    var _a = props.data.renderData, renderData = _a === void 0 ? [] : _a;
