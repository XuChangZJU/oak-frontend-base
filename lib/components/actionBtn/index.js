    ...
    lifetimes: {
        ...
        ready: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, actions, extraActions, onAction, entity, cascadeActions, schema, items_1, moreItems;
                var _this = this;
                return tslib_1.__generator(this, function (_b) {
                    ...
                    if (extraActions && actions && extraActions.length) {
                        ...
                        items_1 = actions.map(function (ele) { return ({
                            action: typeof ele !== 'string' ? ele.action : ele,
                            path: '',
                            label: _this.getLabel(ele, entity),
                            onClick: function () { return onAction && onAction(typeof ele !== 'string' ? ele.action : ele, undefined); },
                        }); });
