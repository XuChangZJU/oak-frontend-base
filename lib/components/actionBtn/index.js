        ...
        makeItems: function (isMobile) {
            ...
            if (schema) {
                ...
                if ((extraActions === null || extraActions === void 0 ? void 0 : extraActions.length) || (actions === null || actions === void 0 ? void 0 : actions.length)) {
                    ...
                    if (extraActions) {
                        // 用户传的action默认排在前面
                        var extraActions2 = extraActions.filter(function (ele) { return ele.show; }) || [];
                        actions2.unshift.apply(actions2, tslib_1.__spreadArray([], tslib_1.__read(extraActions2), false));
                    }
