...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.panelContainer }, { children: (0, jsx_runtime_1.jsx)(antd_1.Space, tslib_1.__assign({ align: 'center' }, { children: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [actions === null || actions === void 0 ? void 0 : actions.map(function (ele, index) {
