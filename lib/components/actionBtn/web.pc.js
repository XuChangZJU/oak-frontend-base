...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.panelContainer }, { children: (0, jsx_runtime_1.jsx)(antd_1.Space, tslib_1.__assign({ align: 'center', style: { width: '100%' } }, { children: (0, jsx_runtime_1.jsx)(antd_1.Space, tslib_1.__assign({ align: 'center', size: 12 }, { children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: items === null || items === void 0 ? void 0 : items.map(function (ele, index) {
