...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.panelContainer, children: (0, jsx_runtime_1.jsx)(antd_1.Space, { align: 'center', size: 12, style: { width: '100%' }, wrap: true, children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: items?.map((ele, index) => {
