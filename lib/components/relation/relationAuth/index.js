...
exports.default = OakComponent({
    ...
    formData: function (_a) {
        ...
        var cascadeEntities = this.features.relationAuth.getCascadeRelationEntitiesByRoot(entity);
        var cascadeEntityRelations = cascadeEntities.map(function (ele) {
            var _a = tslib_1.__read(ele, 3), e = _a[0], p = _a[1], r = _a[2];
    ...
    lifetimes: {
        ready: function () {
            ...
            var cascadeRelationEntities = this.features.relationAuth.getCascadeRelationEntitiesByRoot(entity);
