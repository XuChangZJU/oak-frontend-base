...
exports.default = OakComponent({
    ...
    formData({ data }) {
        ...
        const sourceEntities = auths.map(ele => ele[2]);
    ...
    listeners: {
        relationIds(prev, next) {
            ...
            if (relationAuths) {
                ...
                relationAuths.forEach((relationAuth) => {
    ...
    methods: {
        onChange(checked, sourceRelationId, path, relationAuths) {
            ...
            if (checked) {
                if (relationAuths) {
                    ...
                    const restRelationIds = (0, lodash_1.difference)(relationIds, includedRelationIds);
