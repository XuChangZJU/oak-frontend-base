...
function render(props) {
    var _a = props.data, paths = _a.paths, directActionAuths = _a.directActionAuths, action = _a.action, oakDirty = _a.oakDirty;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Table, { columns: [
                    {
                        key: '2',
                        title: t('directActionAuth:attrs.sourceEntity'),
                        width: 100,
                    ...
                    {
                        key: '1',
                        title: t('directActionAuth:attrs.path'),
                        width: 200,
                        render: function (value, record) {
                            return record[1];
                        },
                    },
                    {
                        ...
                        width: 300,
                        render: function (value, record) {
                            var hasDaa = !!(directActionAuths === null || directActionAuths === void 0 ? void 0 : directActionAuths.find(function (daa) { return !daa.$$deleteAt$$ && daa.path === record[1] && daa.deActions.includes(action); }));
                            return ((0, jsx_runtime_1.jsx)(antd_1.Checkbox, tslib_1.__assign({ disabled: !action, checked: hasDaa, onChange: function (_a) {
