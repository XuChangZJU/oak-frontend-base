...
exports.default = OakComponent({
    ...
    formData: function () {
        ...
        var deducedRelationAttr = this.features.relationAuth.getDeduceRelationAttribute(entity);
        return {
            relations: relations,
            actions: actions,
            hasDirectActionAuth: daas.length > 0,
            hasDirectRelationAuth: dras.length > 0,
            deducedRelationAttr: deducedRelationAttr,
        };
    },
    lifetimes: {
        ready: function () {
    ...
    methods: {
        ...
        onRelationSelected: function (relationId) {
            this.setState({ relationId: relationId });
        }
    }
});
