...
var ProList = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        if (schema) {
            ...
            var newTabelAttributes = judgeAttributes.map(function (ele) { return ({ attribute: ele, show: true }); });
    ...
    return ((0, jsx_runtime_1.jsx)(exports.TableContext.Provider, tslib_1.__assign({ value: {
            ...
            onReset: function () {
                if (schema) {
                    var judgeAttributes = (0, usefulFn_1.translateAttributes)(schema, entity, attributes);
                    var newTableAttr = judgeAttributes.map(function (ele) { return ({ attribute: ele, show: true }); });
                    setTableAttributes(newTableAttr);
                }
            }
        } }, { children: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: index_module_less_1.default.listContainer }, { children: [!isMobile && ((0, jsx_runtime_1.jsx)(toolBar_1.default, { title: title || undefined, buttonGroup: buttonGroup, reload: function () {
                        onReload && onReload();
