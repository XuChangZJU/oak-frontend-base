...
function Render(props) {
    ...
    if (mode === 'table-cell') {
        return ((0, jsx_runtime_1.jsxs)(antd_1.Space, tslib_1.__assign({}, spaceProps, { children: [newItems === null || newItems === void 0 ? void 0 : newItems.map(function (ele, index) {
                    ...
                    }, placement: "top", arrow: true, children: (0, jsx_runtime_1.jsx)("a", { onClick: function (e) { return e.preventDefault(); }, children: "\u66F4\u591A" }) }))] })));
    }
    return ((0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.panelContainer, children: [moreItems && moreItems.length > 0 && ((0, jsx_runtime_1.jsx)(antd_1.Dropdown, { menu: {
                ...
                }, arrow: true, children: (0, jsx_runtime_1.jsx)(antd_1.Typography, { className: web_module_less_1.default.more, children: "\u66F4\u591A" }) })), (0, jsx_runtime_1.jsx)(antd_1.Space, tslib_1.__assign({}, spaceProps, { children: newItems === null || newItems === void 0 ? void 0 : newItems.map(function (ele, index) {
