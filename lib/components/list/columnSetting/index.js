...
function ListItem(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: index_module_less_1.default.listItemView, onClick: onSelect, children: [(0, jsx_runtime_1.jsx)("div", { className: index_module_less_1.default.listItemTitle, children: title }), !disabled ? ((0, jsx_runtime_1.jsxs)("div", { className: index_module_less_1.default.listIconView, children: [(0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: features.locales.t('leftPin'), children: showToTop && ((0, jsx_runtime_1.jsx)("div", { className: index_module_less_1.default.listIcon, onClick: (e) => {
                                e.stopPropagation();
                                e.preventDefault();
                                onMoveTop();
                                ...
                                e.preventDefault();
                                onMoveBottom();
                            }, children: (0, jsx_runtime_1.jsx)(icons_1.VerticalAlignBottomOutlined, {}) })) })] })) : null] }));
}
