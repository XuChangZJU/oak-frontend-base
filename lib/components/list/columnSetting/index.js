...
function ListItem(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: index_module_less_1.default.listItemView, onClick: onSelect }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default.listItemTitle }, { children: title })), (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: index_module_less_1.default.listIconView }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Tooltip, tslib_1.__assign({ title: t("leftPin") }, { children: showToTop && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default.listIcon, onClick: function (e) {
                                e.stopPropagation();
                                e.preventDefault();
                                onMoveTop();
                            } }, { children: (0, jsx_runtime_1.jsx)(icons_1.VerticalAlignTopOutlined, {}) }))) })), (0, jsx_runtime_1.jsx)(antd_1.Tooltip, tslib_1.__assign({ title: t("rightPin") }, { children: showToBottom && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default.listIcon, onClick: function (e) {
                                e.stopPropagation();
                                e.preventDefault();
                                onMoveBottom();
...
function ColumnSetting() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (schema && entity && tableAttributes) {
            tableAttributes.forEach(function (ele, index) {
                ...
                var title = (0, usefulFn_1.getLabel)(ele.attribute, entityI18n, attr, t);
                newTreeData.push({
                    title: title,
                    key: path,
                    keyIndex: index,
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Popover, tslib_1.__assign({ arrow: false, title: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: index_module_less_1.default.titleView }, { children: [(0, jsx_runtime_1.jsx)("strong", { children: t('columnSetting') }), (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ type: 'link', onClick: onReset }, { children: t('common:reset') }))] })), trigger: "click", placement: "bottomRight", content: (0, jsx_runtime_1.jsx)(antd_1.Space, { children: listDom }) }, { children: (0, jsx_runtime_1.jsx)(antd_1.Tooltip, tslib_1.__assign({ title: t('columnSetting') }, { children: (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default.iconBox }, { children: (0, jsx_runtime_1.jsx)(icons_1.SettingOutlined, {}) })) })) })));
}
