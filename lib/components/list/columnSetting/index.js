...
function ListItem(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: index_module_less_1.default.listItemView, onClick: onSelect, children: [(0, jsx_runtime_1.jsx)("div", { className: index_module_less_1.default.listItemTitle, children: title }), (0, jsx_runtime_1.jsxs)("div", { className: index_module_less_1.default.listIconView, children: [(0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: features.locales.t('leftPin'), children: showToTop && ((0, jsx_runtime_1.jsx)("div", { className: index_module_less_1.default.listIcon, onClick: function (e) {
                                e.stopPropagation();
                                e.preventDefault();
                                onMoveTop();
                            }, children: (0, jsx_runtime_1.jsx)(icons_1.VerticalAlignTopOutlined, {}) })) }), (0, jsx_runtime_1.jsx)(antd_1.Tooltip, { title: features.locales.t('rightPin'), children: showToBottom && ((0, jsx_runtime_1.jsx)("div", { className: index_module_less_1.default.listIcon, onClick: function (e) {
                                e.stopPropagation();
                                e.preventDefault();
                                onMoveBottom();
...
function ColumnSetting() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (schema && entity && tableAttributes) {
            tableAttributes.forEach(function (ele, index) {
                var title = (0, usefulFn_1.getLabel)(ele.attribute.attribute, ele.attribute.entity, ele.attribute.attr, function (k, p) { return features.locales.t(k, p); });
                newTreeData.push({
                    title: title,
    ...
    var move = function (path, targetPath, dropPosition) {
        ...
        var findIndex = newAttributes.findIndex(function (ele) { return (0, usefulFn_1.getPath)(ele.attribute.attribute) === path; });
        var targetIndex = newAttributes.findIndex(function (ele) { return (0, usefulFn_1.getPath)(ele.attribute.attribute) === targetPath; });
    ...
    var onCheck = function (node) {
        var tableArr = tableAttributes.find(function (ele) { return (0, usefulFn_1.getPath)(ele.attribute.attribute) === node.key; });
        if (tableArr) {
    ...
    var listDom = ((0, jsx_runtime_1.jsx)(antd_1.Tree, { itemHeight: 24, draggable: true, checkable: true, onDrop: function (info) {
            ...
            var position = dropPosition === -1 || !dropToGap
                ? dropPosition + 1
                : dropPosition;
            move(dragKey, dropKey, position);
        }, blockNode: true, onCheck: function (checkedKeys, e) {
            onCheck(e.node);
        }, titleRender: function (node) { return ((0, jsx_runtime_1.jsx)(ListItem, { title: node.title, nodeKey: node.key, showToTop: node.keyIndex !== 0, showToBottom: node.keyIndex !== treeData.length - 1, onSelect: function () { return onCheck(node); }, onMoveTop: function () { return move(node.key, treeData[0].key, 0); }, onMoveBottom: function () {
                return move(node.key, treeData[treeData.length - 1].key, treeData.length + 1);
            } })); }, checkedKeys: checkedKeys, showLine: false, treeData: treeData }));
