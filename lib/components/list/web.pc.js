...
function Render(props) {
    ...
    var _d = tslib_1.__read((0, react_1.useState)([]), 2), selectedRowKeys = _d[0], setSelectedRowKeys = _d[1];
    var _e = tslib_1.__read((0, react_1.useState)([]), 2), tableColumns = _e[0], setTabelColumns = _e[1];
