...
function Render(props) {
    ...
    var loading = oakData.loading, entity = oakData.entity, schema = oakData.schema, extraActions = oakData.extraActions, data = oakData.data, columns = oakData.columns, colorDict = oakData.colorDict, _e = oakData.disabledOp, disabledOp = _e === void 0 ? false : _e, handleClick = oakData.handleClick, tablePagination = oakData.tablePagination, onAction = oakData.onAction, rowSelection = oakData.rowSelection, width = oakData.width, scroll = oakData.scroll, attributes = oakData.attributes, i18n = oakData.i18n;
    // 为了i18更新时能够重新渲染
                ...
                var column = {
                    ...
                    render: function (v, row) {
                        ...
                        if (type === 'tag' && !!value) {
                            ...
                            color = colorDict && colorDict[entityI8n][attr][value];
                        }
