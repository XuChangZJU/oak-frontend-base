...
function Render(props) {
    ...
    var loading = oakData.loading, entity = oakData.entity, schema = oakData.schema, extraActions = oakData.extraActions, oakEntity = oakData.oakEntity, data = oakData.data, columns = oakData.columns, colorDict = oakData.colorDict, _b = oakData.disabledOp, disabledOp = _b === void 0 ? false : _b, handleClick = oakData.handleClick, tablePagination = oakData.tablePagination, onAction = oakData.onAction;
            ...
            tableColumns.push({
                ...
                render: function (value, row) {
                    ...
                    if (extraActions && extraActions.length) {
                        oakActions.unshift.apply(oakActions, tslib_1.__spreadArray([], tslib_1.__read(extraActions), false));
                    }
                    return ((0, jsx_runtime_1.jsx)(actionBtn_1.default, { schema: schema, entity: entity, actions: row === null || row === void 0 ? void 0 : row['#oakLegalActions'], cascadeActions: row === null || row === void 0 ? void 0 : row['#oakLegalCascadeActions'], onAction: function (action, cascadeAction) { return onAction && onAction(row, action, cascadeAction); } }));
                }
            });
        }
        setTabelColumns(tableColumns);
    }, [data]);
    return ((0, jsx_runtime_1.jsx)(antd_1.Table, { loading: loading, dataSource: data, scroll: { x: 1500 }, columns: tableColumns, pagination: tablePagination }));
}
