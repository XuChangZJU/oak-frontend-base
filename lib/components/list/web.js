...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: mobile_module_less_1.default.container, children: oakLoading ? ((0, jsx_runtime_1.jsx)("div", { className: mobile_module_less_1.default.loadingView, children: (0, jsx_runtime_1.jsx)(antd_1.Spin, { size: 'large' }) })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: mobileData && mobileData.map(function (ele) {
                var _a, _b;
                return ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', alignItems: 'center', flex: 1 }, children: [useSelect && ((0, jsx_runtime_1.jsx)(antd_mobile_1.Checkbox, { checked: selectedRowKeys.includes(ele.record.id), onChange: function (checked) {
                                if (checked) {
                            ...
                            } })), (0, jsx_runtime_1.jsxs)("div", { className: mobile_module_less_1.default.card, onClick: function () {
                                var _a, _b, _c;
