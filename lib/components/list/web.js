...
function Render(props) {
    ...
    var entity = oakData.entity, schema = oakData.schema, oakEntity = oakData.oakEntity, data = oakData.data, columns = oakData.columns, colorDict = oakData.colorDict, _b = oakData.disabledOp, disabledOp = _b === void 0 ? false : _b, handleClick = oakData.handleClick, tablePagination = oakData.tablePagination;
        ...
        if (!disabledOp && tableColumns) {
            tableColumns.push({
                ...
                render: function (value, row) {
                    ...
                    return ((0, jsx_runtime_1.jsx)(actionBtn_1.default, { schema: schema, entity: entity, actions: row === null || row === void 0 ? void 0 : row['#oakLegalActions'], cascadeActions: row === null || row === void 0 ? void 0 : row['#oakLegalCascadeActions'], onClick: function (action) { return handleClick && handleClick(id, action); } }));
                }
            });
        }
