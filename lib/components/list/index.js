    ...
    lifetimes: {
        ready: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, attributes, entity, data, attributesMb, t, schema, colorDict, converter;
                return tslib_1.__generator(this, function (_b) {
                    ...
                    if (attributesMb) {
                        converter = (0, usefulFn_1.analyzeAttrMobileForCard)(schema, entity, t, attributesMb, colorDict);
                        this.setState({
                            converter: converter,
                            colorDict: colorDict,
                        });
