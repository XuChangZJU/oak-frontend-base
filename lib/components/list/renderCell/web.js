...
function Render(props) {
    ...
    if (value === null || value === '' || value === undefined) {
        ...
        if (value instanceof Array) {
            return ((0, jsx_runtime_1.jsx)(antd_1.Space, tslib_1.__assign({ direction: "vertical" }, { children: value.map(function (ele) { return ((0, jsx_runtime_1.jsx)(Link, tslib_1.__assign({ href: ele, target: "_blank", ellipsis: true }, { children: ele }))); }) })));
        }
        return ((0, jsx_runtime_1.jsx)(Link, tslib_1.__assign({ href: value, target: "_blank", ellipsis: true }, { children: value })));
    }
    return ((0, jsx_runtime_1.jsx)(Text, tslib_1.__assign({ ellipsis: true }, { children: value })));
}
