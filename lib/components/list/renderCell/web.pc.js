...
function Render(props) {
    ...
    // 属性类型是enum要使用标签
        ...
        var href_1 = linkUrl;
        if (value instanceof Array) {
            return ((0, jsx_runtime_1.jsx)(antd_1.Space, { direction: "vertical", children: value.map(function (ele) {
                    href_1 = ele;
                    if (linkUrl) {
                        href_1 = linkUrl;
                    }
                    return ((0, jsx_runtime_1.jsx)(Link, { href: href_1, children: ele }));
                }) }));
        }
        return ((0, jsx_runtime_1.jsx)(Link, { href: href_1, children: value }));
    }
