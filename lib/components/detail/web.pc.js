...
function Render(props) {
    ...
    var t = methods.t;
    var entity = oakData.entity, title = oakData.title, colorDict = oakData.colorDict, bordered = oakData.bordered, _a = oakData.column, column = _a === void 0 ? DEFAULT_COLUMN_MAP : _a, renderData = oakData.renderData, _b = oakData.layout, layout = _b === void 0 ? "horizontal" : _b;
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions, tslib_1.__assign({ title: title, column: column, bordered: bordered, layout: layout }, { children: data === null || data === void 0 ? void 0 : data.map(function (ele) { return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, tslib_1.__assign({ label: t(ele.label), span: ele.span || 1 }, { children: ele.value }))); }) })));
}
