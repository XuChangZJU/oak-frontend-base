...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions, tslib_1.__assign({ title: title, column: column, bordered: bordered, layout: layout }, { children: judgeAttributes === null || judgeAttributes === void 0 ? void 0 : judgeAttributes.map(function (ele) {
            var _a, _b;
            ...
            var renderWidth = (0, usefulFn_1.getWidth)(ele.attribute, ele.attrType);
            ...
            return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, tslib_1.__assign({ label: renderLabel, span: renderWidth || 1 }, { children: (0, jsx_runtime_1.jsx)(RenderRow, { type: ele.attrType, value: renderValue, color: color }) })));
        }) })));
}
