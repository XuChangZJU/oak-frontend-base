...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: mobile_module_less_1.default.panel }, { children: [title && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: mobile_module_less_1.default.title }, { children: title }))), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: mobile_module_less_1.default.panel_content }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Space, tslib_1.__assign({ direction: "vertical", style: { '--gap': '10px' } }, { children: judgeAttributes && judgeAttributes.map(function (ele) {
                        ...
                        return ((0, jsx_runtime_1.jsx)(RenderRow, { label: renderLabel, value: renderValue, type: ele.attrType }));
                    }) })) }))] })));
}
