...
function Render(props) {
    ...
    var data = renderData.map(function (ele) {
        ...
        if ((ele === null || ele === void 0 ? void 0 : ele.type) === 'enum') {
            Object.assign(item, {
                value: ((0, jsx_runtime_1.jsx)(antd_1.Tag, tslib_1.__assign({ color: colorDict[entity][ele.attr][String(ele.value)] }, { children: ele.value }))),
            });
        }
        if ((ele === null || ele === void 0 ? void 0 : ele.type) === 'image') {
            Object.assign(item, {
                value: ((0, jsx_runtime_1.jsx)("div", { children: (_a = ele.value) === null || _a === void 0 ? void 0 : _a.map(function (ele1) { return ((0, jsx_runtime_1.jsx)(antd_1.Image, { src: ele1 })); }) })),
                span: 4,
            });
        }
