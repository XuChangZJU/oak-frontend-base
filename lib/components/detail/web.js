...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions, tslib_1.__assign({ column: column, bordered: true }, { children: data === null || data === void 0 ? void 0 : data.map(function (ele) { return ((0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, tslib_1.__assign({ label: t(ele.label), span: ele.span || 1 }, { children: ele.value }))); }) })));
}
