...
function Render(props) {
    ...
    tfColumns.forEach(function (column, index) {
        ...
        var item = ((0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ span: gridColumn * colSpan2 }, { children: (0, jsx_runtime_1.jsx)(filter2_1.default, { column: column, entity: entity, oakPath: oakFullpath }) })));
        if (index === 0) {
            firstItem = item;
        }
        if (!open) {
    ...
    var formItemLayout = formLayout === 'horizontal' ? { labelCol: { style: { width: 120 } }, wrapperCol: { style: { maxWidth: 'calc(100% - 120px)' } } } : null;
    var buttonItemLayout = formLayout === 'horizontal' ? { wrapperCol: { span: 18, offset: 6 } } : null;
    items.push((0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ span: _gridColumn }, { children: (0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({}, buttonItemLayout, { children: (0, jsx_runtime_1.jsxs)(antd_1.Space, tslib_1.__assign({ className: web_module_less_1.default.actionBox }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Badge, tslib_1.__assign({ count: count }, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ type: "default", onClick: function () {
    ...
    return ((0, jsx_runtime_1.jsx)(antd_1.Form, tslib_1.__assign({ form: form }, formItemLayout, { layout: formLayout }, { children: (0, jsx_runtime_1.jsx)(antd_1.Row, tslib_1.__assign({ gutter: [16, 16] }, { children: items })) })));
}
