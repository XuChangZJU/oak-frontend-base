...
function Render(props) {
    ...
    tfColumns.forEach(function (column, index) {
        ...
        var item = ((0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ span: gridColumn * colSpan2 }, { children: (0, jsx_runtime_1.jsx)(filter_1.default, { column: column, entity: entity, oakPath: oakFullpath }) })));
        if (index === 0) {
            firstItem = item;
        }
        if (!open) {
