...
exports.default = OakComponent({
    ...
    formData: function () {
        ...
        var _label = column.label, selectProps = column.selectProps;
        // 兼容小程序和web，数据要在这里处理
        // 小程序, 在这里可以直接使用t进行翻译
        var labelMp = '';
        ...
        if (_label) {
            ...
            labelMp =
                entityI18n && attrI18n
                    ? this.t("".concat(entityI18n, ":attr.").concat(attrI18n))
                    : '';
        }
        ...
        if (viewType === 'Select') {
            ...
            if (enumeration) {
                var exclude_1 = [];
                if (selectProps === null || selectProps === void 0 ? void 0 : selectProps.exclude) {
                    if (typeof selectProps.exclude === 'string') {
                        exclude_1 = [selectProps.exclude];
                    }
                    else {
                        exclude_1 = selectProps.exclude;
                    }
                ...
                options = enumeration
                    .filter(function (ele) { return !exclude_1.includes(ele); })
