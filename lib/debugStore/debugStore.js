...
var DebugStore = /** @class */ (function (_super) {
    ...
    function DebugStore(storageSchema, contextBuilder) {
        ...
        _this.executor = new TriggerExecutor_1.TriggerExecutor(function (cxtString) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!(option === null || option === void 0 ? void 0 : option.ignoreTrigger)) return [3 /*break*/, 2];
                    ...
                    case 3:
                        result = _a.sent();
                        if (!!(option === null || option === void 0 ? void 0 : option.ignoreTrigger)) return [3 /*break*/, 5];
