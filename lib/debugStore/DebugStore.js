...
var DebugStore = /** @class */ (function (_super) {
    ...
    function DebugStore(storageSchema, contextBuilder, actionCascadeGraph, relationCascadeGraph, authDeduceRelationMap, selectFreeEntities, createFreeEntities, updateFreeEntities) {
        ...
        _this.relationAuth = new RelationAuth_1.RelationAuth(storageSchema, actionCascadeGraph, relationCascadeGraph, authDeduceRelationMap, selectFreeEntities, createFreeEntities, updateFreeEntities);
        return _this;
    }
    DebugStore.prototype.exec = function (script, txnId) {
