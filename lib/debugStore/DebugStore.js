...
var DebugStore = /** @class */ (function (_super) {
    ...
    function DebugStore(storageSchema, contextBuilder, actionCascadeGraph, relationCascadeGraph) {
        ...
        _this.relationAuth = new RelationAuth_1.RelationAuth(actionCascadeGraph, relationCascadeGraph, storageSchema);
