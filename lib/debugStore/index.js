...
function createDebugStore(storageSchema, contextBuilder, triggers, checkers, watchers, initialData, actionDict) {
    ...
    (0, assert_1.default)(actionDict);
    const { triggers: adTriggers, checkers: adCheckers, watchers: adWatchers } = (0, actionDef_1.analyzeActionDefDict)(storageSchema, actionDict);
