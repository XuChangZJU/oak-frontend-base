...
function createDebugStore(storageSchema, contextBuilder, triggers, checkers, watchers, timers, startRoutines, initialData, actionDict, actionCascadePathGraph, relationCascadePathGraph) {
    var store = new DebugStore_1.DebugStore(storageSchema, contextBuilder, actionCascadePathGraph || [], relationCascadePathGraph || []);
