 ...
 * @returns
 */
function initialize(storageSchema, frontendContextBuilder, connector, checkers, actionDict, actionCascadePathGraph, relationCascadePathGraph, cascadeRemoveDict, colorDict) {
    var _this = this;
