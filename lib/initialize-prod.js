 ...
 * @returns
 */
function initialize(storageSchema, frontendContextBuilder, connector, checkers, actionDict, authDict, relationDict, colorDict) {
    var _this = this;
    ...
    var features = (0, features_1.initialize)(wrapper, storageSchema, function () { return frontendContextBuilder()(cacheStore); }, cacheStore, relationDict || {}, authDict || {}, colorDict || {}, function (url, headers) { return connector.makeBridgeUrl(url, headers); });
